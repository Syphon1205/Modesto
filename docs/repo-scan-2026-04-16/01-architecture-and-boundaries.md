...
- [`apps/server/src/orchestration`](/Users/dev/modesto/apps/server/src/orchestration)
- [`apps/server/src/provider`](/Users/dev/modesto/apps/server/src/provider)
- [`apps/server/src/persistence`](/Users/dev/modesto/apps/server/src/persistence)
...
[`packages/contracts/src/orchestration.ts`](/Users/dev/modesto/packages/contracts/src/orchestration.ts) is large enough that future protocol churn could become noisy and hard to review.
