...
- CI is already meaningful, especially in [`.github/workflows/ci.yml`](/Users/dev/modesto/.github/workflows/ci.yml).
- Release automation is documented and practical in [`docs/release.md`](/Users/dev/modesto/docs/release.md).
- Contribution expectations are clear in [`CONTRIBUTING.md`](/Users/dev/modesto/CONTRIBUTING.md).
...
This makes planning easier than one broad [`TODO.md`](/Users/dev/modesto/TODO.md).
