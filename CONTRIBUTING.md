...
Modesto is open source under AGPL-3.0 (see `LICENSE`). By submitting a contribution, you agree it may be distributed under that same license. Code taken from Modesto at or before the last MIT release remains available under MIT.
