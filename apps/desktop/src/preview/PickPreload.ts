...
const OVERLAY_ATTRIBUTE = "data-modesto-annotation-ui";
...
function startAnnotation(): void {
  ...
  const refreshToolButtons = (): void => {
    ...
    document.documentElement.setAttribute("data-modesto-annotation-tool", tool);
  };
  ...
  const teardown = (notifyMain: boolean): void => {
    ...
    document.documentElement.removeAttribute("data-modesto-annotation-tool");
    cursorStyle.remove();
    host.remove();
    activeSession = null;
