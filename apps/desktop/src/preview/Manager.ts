...
import { normalizePreviewUrl } from "@modesto/shared/preview";
...
import { playwrightInjectedRuntimeInstallExpression } from "@modesto/shared/playwrightInjectedRuntime";
...
const makeNativeOperations = Effect.fn("PreviewManager.makeOperations")(function* (
  ...
  const setWindowBackgroundThrottling = Effect.fnUntraced(function* (
    ...
    if (MainWindowBackgroundThrottling.isMainWindowBackgroundThrottlingBound(window)) {
      // enabled=false means keep the renderer awake for capture.
      MainWindowBackgroundThrottling.setMainWindowFrameCaptureHold(!enabled);
      return;
    }
...
>()("@modesto/desktop/preview/Manager/PreviewManager") {}
