...
import type { DesktopPreviewRecordingFrame } from "@modesto/contracts";
...
const browserSessionLayer = Layer.succeed(
  ...
  BrowserSession.BrowserSession.of({
    getPartition: () => Effect.succeed("persist:modesto-preview-test"),
    isPartition: (partition) => partition.startsWith("persist:modesto-preview-"),
