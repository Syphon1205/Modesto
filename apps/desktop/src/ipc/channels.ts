...
export const REQUEST_LISTENING_LIBRARY_CHANNEL = "desktop:request-listening-library";
export const LIST_LISTENING_LIBRARY_PLAYLISTS_CHANNEL = "desktop:list-listening-library-playlists";
export const LIST_LISTENING_LIBRARY_TRACKS_CHANNEL = "desktop:list-listening-library-tracks";
export const CONTROL_LISTENING_LIBRARY_CHANNEL = "desktop:control-listening-library";
export const LISTENING_LIBRARY_PLAYBACK_CHANNEL = "desktop:listening-library-playback";
export const AMBIENT_PRESENCE_OPEN_CHANNEL = "desktop:ambient-presence-open";
export const AMBIENT_PRESENCE_CLOSE_CHANNEL = "desktop:ambient-presence-close";
export const AMBIENT_PRESENCE_SET_BUBBLES_CHANNEL = "desktop:ambient-presence-set-bubbles";
export const AMBIENT_PRESENCE_STATE_CHANNEL = "desktop:ambient-presence-state";
export const AMBIENT_PRESENCE_NAVIGATE_CHANNEL = "desktop:ambient-presence-navigate";
...
export const PREVIEW_PROBE_SIGN_IN_CHANNEL = "desktop:preview-probe-sign-in";
...
export const OPEN_APPLICATION_CHANNEL = "desktop:open-application";
export const FLOATING_CHAT_OPEN_CHANNEL = "desktop:floating-chat-open";
export const FLOATING_CHAT_CLOSE_CHANNEL = "desktop:floating-chat-close";
export const APPSHOT_CAPTURE_NOW_CHANNEL = "desktop:appshot-capture-now";
export const APPSHOT_PERMISSION_STATUS_CHANNEL = "desktop:appshot-permission-status";
export const APPSHOT_OPEN_PRIVACY_SETTINGS_CHANNEL = "desktop:appshot-open-privacy-settings";
export const APPSHOT_RECEIVED_CHANNEL = "desktop:appshot-received";
export const SET_RENDERER_ACTIVITY_CHANNEL = "desktop:set-renderer-activity";
