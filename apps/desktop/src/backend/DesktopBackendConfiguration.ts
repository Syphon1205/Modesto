...
>()("@modesto/desktop/backend/DesktopBackendConfiguration") {}
...
const DESKTOP_BACKEND_ENV_NAMES = [
  ...
  "MODESTO_NO_BROWSER",
  "MODESTO_HOST",
  "MODESTO_DESKTOP_WS_URL",
  "MODESTO_DESKTOP_LAN_ACCESS",
  "MODESTO_DESKTOP_LAN_HOST",
  "MODESTO_DESKTOP_HTTPS_ENDPOINTS",
  "MODESTO_TAILSCALE_SERVE",
  "MODESTO_TAILSCALE_SERVE_PORT",
] as const;
...
const resolvePrimaryStartConfig = Effect.fn("desktop.backendConfiguration.resolvePrimary")(
  ...
  > {
    ...
    return {
      ...
      // Primary wants process.env (PATH, dev-runner's MODESTO_HOME, etc.).
      extendEnv: true,
      bootstrap,
...
> {
  ...
  // Build an explicit copy of process.env minus MODESTO_HOME (dev-runner
  ...
  const baseConfig = {
    ...
    // env is already a complete process.env minus MODESTO_HOME; pass it
