...
import { clerkFrontendApiHostnameFromPublishableKey } from "@modesto/shared/relayAuth";
...
>()("@modesto/desktop/app/DesktopClerk") {}
...
export const make = Effect.gen(function* () {
  ...
  // the lock would create "Modesto (Alpha)" and make the legacy-install
