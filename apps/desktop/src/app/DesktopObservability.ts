import { PRIMARY_LOCAL_ENVIRONMENT_ID } from "@modesto/contracts";
import { makeLocalFileTracer, makeTraceSink } from "@modesto/shared/observability";
...
>()("@modesto/desktop/app/DesktopObservability/DesktopBackendOutputLogFactory") {}
