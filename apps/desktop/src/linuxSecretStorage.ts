...
function getGnomeKeyringRemediationMessage(): string {
  return "Modesto could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart Modesto.";
}

function getKWalletRemediationMessage(): string {
  return "Modesto could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart Modesto.";
}
