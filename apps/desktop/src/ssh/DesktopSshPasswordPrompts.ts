import type { DesktopSshPasswordPromptRequest } from "@modesto/contracts";
import { DesktopSshPasswordPromptResolutionInputSchema } from "@modesto/contracts";
import type { SshPasswordRequest } from "@modesto/ssh/auth";
...
export class DesktopSshPromptWindowUnavailableError extends Schema.TaggedErrorClass<DesktopSshPromptWindowUnavailableError>()(
  ...
  override get message(): string {
    ...
    return `Modesto window is unavailable during ${this.stage} for SSH authentication to ${this.destination} (request: ${request}).`;
  }
}
...
>()("@modesto/desktop/ssh/DesktopSshPasswordPrompts") {}
