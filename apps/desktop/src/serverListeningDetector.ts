...
export class ServerListeningDetector {
  ...
  constructor() {
    ...
    // A restarted backend may exit before anything is actively awaiting this
    // detector. Keep that expected lifecycle failure from becoming a process-wide
    // unhandled rejection; callers that do await `promise` still receive it.
