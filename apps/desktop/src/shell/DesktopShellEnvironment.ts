...
>()("@modesto/desktop/shell/DesktopShellEnvironment") {}
...
const startMarker = (name: string) => `__MODESTO_ENV_${name}_START__`;
const endMarker = (name: string) => `__MODESTO_ENV_${name}_END__`;
