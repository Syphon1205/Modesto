...
import { isBrowserCopyLinkChord } from "@modesto/shared/browserShortcuts";
import {
...
const BROWSER_SESSION_PARTITION = "persist:modesto-browser";
...
export class DesktopBrowserManager {
  ...
  // string. Centralized here (and in `@modesto/shared/browserSession`) so every browser
