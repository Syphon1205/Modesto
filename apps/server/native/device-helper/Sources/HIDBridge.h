...
typedef NS_ENUM(NSInteger, ModestoHardwareButton) {
  ModestoHardwareButtonHome,
  ModestoHardwareButtonLock,
  ModestoHardwareButtonSide,
  ModestoHardwareButtonSiri,
  ModestoHardwareButtonVolumeUp,
  ModestoHardwareButtonVolumeDown,
};
...
@interface ModestoHIDBridge : NSObject
...
- (void)tapButton:(ModestoHardwareButton)button NS_SWIFT_NAME(tapButton(_:));
