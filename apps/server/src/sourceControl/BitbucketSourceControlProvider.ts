...
import { SourceControlProviderError, type ChangeRequest } from "@modesto/contracts";
...
export const makeDiscovery = Effect.gen(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set MODESTO_BITBUCKET_EMAIL and MODESTO_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request, repository, and user read scopes).",
