import { tokenizeCliArgs } from "@modesto/shared/cliArgs";

export const MODESTO_CODEX_LAUNCH_ARGS_ENV = "MODESTO_CODEX_LAUNCH_ARGS";

export const resolveCodexLaunchArgs = (
  launchArgs?: string,
  environment: NodeJS.ProcessEnv = process.env,
) => environment[MODESTO_CODEX_LAUNCH_ARGS_ENV]?.trim() || launchArgs?.trim() || "";
