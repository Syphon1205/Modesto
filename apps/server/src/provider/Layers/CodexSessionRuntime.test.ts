...
import { DEFAULT_MODEL, ThreadId } from "@modesto/contracts";
...
describe("buildCodexDeveloperInstructions", () => {
  it("appends runtime info after the mode instructions", () => {
    ...
    NodeAssert.match(instructions, /Modesto/);
...
describe("T3 browser developer instructions", () => {
  it("prefers the product-native preview tools in both collaboration modes", () => {
    for (const instructions of [
      ...
      NodeAssert.match(instructions, /Do not start or restart Bun/);
      NodeAssert.match(instructions, /simulator_list/);
  ...
  it("omits the browser block entirely when the preview tools are not attached", () => {
    for (const instructions of [
      ...
      NodeAssert.doesNotMatch(instructions, /simulator_list/);
      NodeAssert.doesNotMatch(instructions, /Modesto collaborative browser/);
