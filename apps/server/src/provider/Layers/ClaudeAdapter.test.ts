    ...
    return Effect.gen(function* () {
      ...
      for (const message of [
        ...
        },
        {
          ...
          provider: "github",
          url: "https://github.com/pingdotgg/modesto/pull/1",
          repo: "pingdotgg/modesto",
          identifier: "1",
          session_id: "session",
          uuid: "ccp",
        },
  ...
  it.effect("classifies Agent tools and read-only Claude tools correctly for approvals", () => {
    ...
    return Effect.gen(function* () {
      ...
      const agentPermissionPromise = canUseTool(
        ...
        {
          signal: new AbortController().signal,
          requestId: "test-request-agent-1",
    ...
    return Effect.gen(function* () {
      ...
      const permissionPromise = canUseTool(
        ...
        },
        {
          ...
          requestId: "test-request-ask-abort",
  ...
  it.effect("stopping a session settles pending user-input waits", () => {
    ...
    return Effect.gen(function* () {
      ...
      const permissionPromise = canUseTool(
        ...
        {
          signal: new AbortController().signal,
          requestId: "test-request-ask-stop",
