...
const GROK_ACP_DEBUG_ENV = "MODESTO_GROK_ACP_DEBUG";
const MODESTO_GROK_ACP_DEBUG_ENV = "MODESTO_GROK_ACP_DEBUG";
...
// override with MODESTO_GROK_TURN_IDLE_TIMEOUT_MS when a workload needs longer.
const GROK_TURN_IDLE_TIMEOUT_MS = resolveAcpTurnIdleTimeoutMs({
  envVar: "MODESTO_GROK_TURN_IDLE_TIMEOUT_MS",
  defaultMs: 600_000,
});
...
const GROK_PLAN_MODE_PROMPT_PREFIX = [
  "Modesto Grok plan mode is active.",
...
function isGrokAcpDebugEnabled(): boolean {
  return (
    ...
    process.env[MODESTO_GROK_ACP_DEBUG_ENV] === "1" ||
