...
export interface ProviderAdapterShape<TError> {
  ...
  /**
   * Install or remove one provider plugin through the provider's own plugin manager.
   */
  readonly setPluginInstalled?: (
    input: ProviderSetPluginInstalledInput,
  ) => Effect.Effect<ProviderSetPluginInstalledResult, TError>;
