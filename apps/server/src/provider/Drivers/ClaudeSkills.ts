...
import type { ClaudeSettings, ServerProviderSkill } from "@modesto/contracts";
...
/** Exported for claudePluginBundle.ts, which parses frontmatter from remote (fetched, not on-disk) skill files with the same YAML rules. */
