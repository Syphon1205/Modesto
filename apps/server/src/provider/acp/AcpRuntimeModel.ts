...
import { deriveToolActivityPresentation } from "@modesto/shared/toolActivity";
import type { ToolLifecycleItemType } from "@modesto/contracts";
...
/**
 * Token usage as ACP reports it on a prompt response.
 *
 * Re-exported through the runtime model rather than having every adapter reach
 * into the generated ACP schema, matching how the other ACP payload shapes in
 * this file are surfaced.
 */
export type AcpUsage = EffectAcpSchema.Usage;
