...
// Purpose: Bridges ACP form elicitation schemas to Modesto's provider-neutral question UI.
// Layer: Provider ACP protocol mapping
// Exports: question extraction and typed ACP response construction.

import type { ProviderUserInputAnswers, UserInputQuestion } from "@modesto/contracts";
...
// Converts primitive ACP form fields into the question shape consumed by Modesto's composer.
