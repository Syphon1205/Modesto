 ...
 */
import { type CursorModelOptions, type ProviderModelDescriptor } from "@modesto/contracts";
import { formatModelDisplayName } from "@modesto/shared/model";
...
// Cursor exposes "auto" as a `default` model id over ACP; keep Modesto's "auto"
