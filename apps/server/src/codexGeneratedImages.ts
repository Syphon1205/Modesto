...
import { isSupportedLocalImagePath as isSupportedLocalImagePathShared } from "@modesto/shared/localPreviewFiles";
 ...
 * writes images under for the current process env. Modesto uses its isolated
 ...
 * overlay `<MODESTO_HOME>/codex-home-overlay/generated_images` so we serve
