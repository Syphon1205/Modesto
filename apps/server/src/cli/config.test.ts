            ...
            ConfigProvider.layer(
              ConfigProvider.fromEnv({
                env: {
                  ...
                  MODESTO_PORT: "4001",
                  MODESTO_HOST: "0.0.0.0",
                  MODESTO_HOME: join(NodeOS.tmpdir(), "ignored-base"),
                  VITE_DEV_SERVER_URL: "http://127.0.0.1:5173",
        ...
        Effect.provide(
          Layer.mergeAll(
            ConfigProvider.layer(
              ConfigProvider.fromEnv({
                env: {
                  MODESTO_BOOTSTRAP_FD: String(fd),
                  MODESTO_NO_BROWSER: "true",
                  MODESTO_AUTO_BOOTSTRAP_PROJECT_FROM_CWD: "true",
                  MODESTO_LOG_WS_EVENTS: "true",
                },
              }),
            ),
