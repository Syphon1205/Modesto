import { readConnectAuthorizeRequest } from "@modesto/shared/connectAuth";
...
const TEST_ENV = {
  MODESTO_CLERK_PUBLISHABLE_KEY: "pk_test_Y2xlcmsuZXhhbXBsZS50ZXN0JA==",
  MODESTO_CLERK_CLI_OAUTH_CLIENT_ID: "oauth_client_test",
  MODESTO_HOSTED_APP_URL: "https://hosted.example.test",
};
