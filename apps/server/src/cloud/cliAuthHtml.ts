...
declare const __MODESTO_BUILD_CHANNEL__: "nightly" | "latest" | undefined;

export function resolveLoopbackAuthorizationStage(): LoopbackAuthorizationStage {
  return typeof __MODESTO_BUILD_CHANNEL__ === "undefined" ? "dev" : __MODESTO_BUILD_CHANNEL__;
}

const stageBrands = {
  dev: "Modesto (Dev)",
  nightly: "Modesto (Nightly)",
  latest: "Modesto",
