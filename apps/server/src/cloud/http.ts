...
import {
  ...
  signRelayJwt,
  verifyRelayJwt,
} from "@modesto/shared/relayJwt";
import { isSecureRelayUrl } from "@modesto/shared/relayUrl";
  ...
  Effect.mapError(
    () =>
      new EnvironmentHttpInternalServerError({
        message: "MODESTO_RELAY_URL must be configured as a secure absolute HTTPS origin.",
      }),
  ),
);
...
export const releaseManagedTunnelOnShutdown = Effect.fn(
  ...
  // persisted URL: MODESTO_RELAY_URL may have changed since the link was made.
