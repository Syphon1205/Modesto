...
export class CodexTextGeneration extends ServiceMap.Service<
  CodexTextGeneration,
  TextGenerationShape
>()("modesto/git/Services/TextGeneration/CodexTextGeneration") {}
...
export class OpenCodeTextGeneration extends ServiceMap.Service<
  ...
  TextGenerationShape
>()("modesto/git/Services/TextGeneration/OpenCodeTextGeneration") {}
...
export class KiloTextGeneration extends ServiceMap.Service<
  KiloTextGeneration,
  TextGenerationShape
>()("modesto/git/Services/TextGeneration/KiloTextGeneration") {}
