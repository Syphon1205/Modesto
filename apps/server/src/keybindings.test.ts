import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@modesto/contracts";
...
import { KeybindingsConfigError } from "@modesto/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "modesto-keybindings-test-",
        }),
      ),
    ),
  );
