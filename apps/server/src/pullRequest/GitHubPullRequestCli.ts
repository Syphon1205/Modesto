...
function filterQualifiers(
  ...
  return [
    ...
    ...(filters.assignee === undefined
      ? []
      : [`assignee:${qualifierValue(resolvePullRequestAuthorFilter(filters.assignee, viewer))}`]),
    ...(filters.mentions === undefined
      ? []
      : [`mentions:${qualifierValue(resolvePullRequestAuthorFilter(filters.mentions, viewer))}`]),
    ...(filters.involves === undefined
      ? []
      : [`involves:${qualifierValue(resolvePullRequestAuthorFilter(filters.involves, viewer))}`]),
