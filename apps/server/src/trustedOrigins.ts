...
//          local machine data only to Modesto's own app surfaces.
// Layer: Server HTTP/security utility
// Exports: normalizeCorsOrigin, isTrustedAppOrigin,
//          shouldRejectUntrustedRequestOrigin

import { MODESTO_DESKTOP_ORIGIN } from "@modesto/shared/desktopIdentity";

import type { ServerConfigShape } from "./config";
import { isLoopbackHost, isWildcardHost } from "./startupAccess";

export const DESKTOP_APP_CORS_ORIGIN = MODESTO_DESKTOP_ORIGIN;
