import { ProviderInstanceId, ThreadId } from "@modesto/contracts";
...
export interface McpSessionRegistryShape {
   ...
   */
  readonly touch: (threadId: ThreadId) => Effect.Effect<boolean>;
 ...
 */
export const touchActiveMcpThread = (threadId: ThreadId): Effect.Effect<boolean | undefined> =>
  activeMcpSessionRegistry ? activeMcpSessionRegistry.touch(threadId) : Effect.succeed(undefined);
