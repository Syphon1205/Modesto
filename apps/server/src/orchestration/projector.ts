import type { OrchestrationEvent, OrchestrationReadModel, ThreadId } from "@modesto/contracts";
import {
  ...
  switch (event.type) {
      ...
      return Effect.gen(function* () {
        ...
        const thread: OrchestrationThread = yield* decodeForEvent(
          OrchestrationThread,
          {
            ...
            handoffReturn: payload.handoffReturn ?? null,
            messages: [],
            activities: [],
            checkpoints: [],
            session: null,
        ...
        Effect.map((payload) => {
          ...
          return {
            ...
            threads: updateThread(nextBase.threads, payload.threadId, {
              ...
              ...(payload.handoffReturn !== undefined
                ? { handoffReturn: payload.handoffReturn }
                : {}),
    ...
    case "thread.turn-start-requested":
      return decodeForEvent(
        ...
        Effect.map((payload) => {
          ...
          // A new turn can change provider; the reactor replaces the old
          // native session before it dispatches the turn.
    ...
    case "thread.message-sent":
      return Effect.gen(function* () {
        ...
        const messagePayload = payload as typeof payload & {
          readonly provenance?: OrchestrationMessage["provenance"];
        };
