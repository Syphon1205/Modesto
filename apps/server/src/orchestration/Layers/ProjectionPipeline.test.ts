...
const BaseTestLayer = makeProjectionPipelinePrefixedTestLayer("modesto-projection-pipeline-test-");
    ...
    Effect.provide(
      Layer.provideMerge(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "modesto-projection-pipeline-fast-forward-",
        }),
        NodeServices.layer,
      ),
    ),
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("modesto-base-")))(
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("modesto-projection-pipeline-approvals-")),
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("modesto-projection-attachments-safe-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("modesto-projection-attachments-overwrite-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("modesto-projection-attachments-rollback-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("modesto-projection-attachments-revert-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("modesto-projection-attachments-delete-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.effect("restores pending turn-start metadata across projection pipeline restart", () =>
  Effect.gen(function* () {
    ...
    Effect.provide(
      Layer.provideMerge(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "modesto-projection-pipeline-restart-",
        }),
        NodeServices.layer,
      ),
    ),
...
const engineLayer = it.layer(
  OrchestrationEngineLive.pipe(
    ...
    Layer.provideMerge(
      ServerConfig.layerTest(process.cwd(), {
        prefix: "modesto-projection-pipeline-engine-dispatch-",
      }),
    ),
    Layer.provideMerge(NodeServices.layer),
  ),
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("modesto-projection-pipeline-turn-finish-")),
)("OrchestrationProjectionPipeline", (it) => {
