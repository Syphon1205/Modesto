...
import { OrchestrationCommand, ORCHESTRATION_WS_METHODS } from "@modesto/contracts";
import {
  Cause,
  Deferred,
  Effect,
...
const makeOrchestrationEngine = Effect.gen(function* () {
  ...
  const buildDeciderReadModel = (
    ...
    switch (command.type) {
      ...
      case "thread.handoff.return":
        return loadThreadDetailForDecider(command, commandReadModel, command.fromThreadId);
