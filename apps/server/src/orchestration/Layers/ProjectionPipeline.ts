...
} from "@modesto/shared/pinnedMessages";
import {
  addThreadMarker,
  removeThreadMarker,
  setThreadMarkerDone,
  setThreadMarkerLabel,
} from "@modesto/shared/threadMarkers";
...
import { deriveThreadSummaryState } from "@modesto/shared/threadSummary";
import {
      ...
      switch (event.type) {
        case "thread.created":
          yield* projectionThreadRepository.upsert({
            ...
            handoffReturn: event.payload.handoffReturn ?? null,
            pinnedMessages: null,
            threadMarkers: null,
            notes: null,
            latestUserMessageAt: null,
        ...
        case "thread.meta-updated": {
          ...
          yield* projectionThreadRepository.upsert({
            ...
            ...(event.payload.handoffReturn !== undefined
              ? { handoffReturn: event.payload.handoffReturn }
              : {}),
        ...
        case "thread.turn-start-requested": {
          ...
          // Provider changes are valid at turn boundaries. The reactor owns
          // replacing the previous provider session.
        ...
        case "thread.message-sent": {
          ...
          const nextAttachments =
            event.payload.attachments !== undefined
              ...
              : Option.isSome(existingMessage)
                ...
                : undefined;
          const messagePayload = event.payload as typeof event.payload & {
          ...
          yield* projectionThreadMessageRepository.upsert({
            ...
            ...(event.payload.dispatchOrigin !== undefined
              ...
              : {}),
            ...(messagePayload.provenance !== undefined
              ? { provenance: messagePayload.provenance }
              : Option.isSome(existingMessage) && existingMessage.value.provenance !== undefined
                ? { provenance: existingMessage.value.provenance }
                : {}),
