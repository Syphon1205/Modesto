...
const ProjectionThreadMessageDbRowSchema = ProjectionThreadMessage.mapFields(
  Struct.assign({
    ...
    provenance: Schema.NullOr(Schema.fromJsonString(ContextProvenance)),
  }),
);
...
const ProjectionThreadDbRowSchema = ProjectionThread.mapFields(
  Struct.assign({
    ...
    handoffReturn: Schema.NullOr(Schema.fromJsonString(ThreadHandoffReturnPayload)),
...
function toProjectedThreadShell(input: {
  ...
  return {
    ...
    handoffReturn: threadRow.handoffReturn,
    ...
    execute: () =>
      sql`
        SELECT
          ...
          handoff_return_json AS "handoffReturn",
