    ...
    execute: () =>
      sql`
        SELECT
          ...
          conversation_mode AS "conversationMode",
        ...
        WITH ranked AS (
          ...
          WHERE threads.deleted_at IS NULL
            ...
            AND (
              ...
              OR threads.conversation_mode = 'chat'
            )
          ...
          ([
            ...
            Effect.gen(function* () {
              ...
              const threads: ReadonlyArray<OrchestrationThread> = threadRows.map((row) => ({
                ...
                conversationMode: row.conversationMode ?? "code",
  ...
  const getThreadShellById: ProjectionSnapshotQueryShape["getThreadShellById"] = (threadId) =>
    Effect.gen(function* () {
      ...
      return Option.some({
        ...
        conversationMode: threadRow.value.conversationMode ?? "code",
