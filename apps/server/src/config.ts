...
export const deriveServerPaths = Effect.fn(function* (
  ...
  return {
    ...
    // Where automations run. They have no repository of their own, so the
    // managed project below owns this folder as its workspace root.
    automationsDir: join(baseDir, "automations"),
    attachmentsDir,
    logsDir,
