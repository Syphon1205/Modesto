...
import Migration0054 from "./Migrations/054_IntegrationTasks.ts";
import Migration0055 from "./Migrations/055_ReviewFindings.ts";
import Migration0056 from "./Migrations/056_ReviewRunMetadata.ts";
import Migration0057 from "./Migrations/057_ThreadHandoffReturnAndMessageProvenance.ts";
...
export const migrationEntries = [
  ...
  [54, "IntegrationTasks", Migration0054],
  [55, "ReviewFindings", Migration0055],
  [56, "ReviewRunMetadata", Migration0056],
  [57, "ThreadHandoffReturnAndMessageProvenance", Migration0057],
] as const;
 ...
 * once the imported tracker's high-water mark reaches Modesto's latest ID,
 * every Modesto migration is skipped silently and startup crashes on missing
 ...
 *
 * Instead, compare the recorded (id, name) pairs against Modesto's lineage and
...
export const reconcileMigrationLineage = Effect.gen(function* () {
  ...
  yield* Effect.logWarning(
    "Migration tracker diverges from the Modesto lineage (legacy import); re-running migrations from the divergence point",
