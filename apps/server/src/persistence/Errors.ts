...
export class MigrationLineageError extends Schema.TaggedErrorClass<MigrationLineageError>()(
  ...
  override get message(): string {
    return (
      ...
      `is recorded as "${this.recordedName}" but Modesto expects "${this.expectedName}". ` +
...
export type IntegrationRepositoryError = PersistenceSqlError | PersistenceDecodeError;
export type ReviewRepositoryError = PersistenceSqlError | PersistenceDecodeError;
