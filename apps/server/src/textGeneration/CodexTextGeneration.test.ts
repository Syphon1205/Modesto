...
import { CodexSettings, ProviderInstanceId, TextGenerationError } from "@modesto/contracts";
  ...
  return Effect.gen(function* () {
    ...
    yield* fs.writeFileString(
      ...
      [
        ...
        "  cat > \"$output_path\" <<'__MODESTO_FAKE_CODEX_OUTPUT__'",
        input.output,
        "__MODESTO_FAKE_CODEX_OUTPUT__",
        "fi",
...
it.layer(CodexTextGenerationTestLayer)("CodexTextGeneration", (it) => {
  ...
  it.effect("uses MODESTO_CODEX_LAUNCH_ARGS for codex exec over settings", () =>
    withFakeCodexEnv(
      {
        output: JSON.stringify({
          subject: "Add important change",
        ...
        environment: { MODESTO_CODEX_LAUNCH_ARGS: " --strict-config --listen off " },
        requireArg: "--strict-config",
