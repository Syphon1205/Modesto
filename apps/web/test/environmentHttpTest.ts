      ...
      Effect.provide([
        ...
        HttpApiBuilder.group(EnvironmentHttpApi, "auth", (handlers) =>
          handlers
            ...
            .handle(
              "loopbackSession",
              Effect.fn("test.environment.auth.loopbackSession")(function* () {
                calls.loopbackSession += 1;
                return yield* (
                  scenario.loopbackSession?.() ?? unexpectedEndpoint("auth.loopbackSession")
                );
              }),
            )
