import type { GitBranch, ProviderKind } from "@modesto/contracts";
import {
...
} from "@modesto/shared/composerSlashCommands";
  ...
  const availableCommands: ComposerSlashCommand[] =
    input.provider !== "claudeAgent"
      ...
      : [
          ...
          // creates a Modesto split/context clone before the provider sees the first turn.
          // /export is app-level too — Modesto owns the thread transcript, so the download
