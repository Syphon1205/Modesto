...
import type { ScopedThreadRef, ServerProviderSkill } from "@modesto/contracts";
import {
  isAtomCommandInterrupted,
  squashAtomCommandFailure,
  type AtomCommandResult,
} from "@modesto/client-runtime/state/runtime";
import { classifyMarkdownImageSource } from "@modesto/client-runtime/markdown-images";
...
import { renderWebAppMentionMarkdownChildren } from "./chat/webAppMentionInline";
...
import { InlineVisual } from "./chat/InlineVisual";
import { inlineVisualKind } from "../studio/inlineVisuals";
import {
...
interface ChatMarkdownProps {
  ...
  /** Only assistant replies opt in to executing sandboxed visual previews. */
  ...
  const markdownComponents = useMemo<Components>(() => {
    ...
    return {
        ...
        return (
          <p {...props}>
            {renderSkillInlineMarkdownChildren(
              renderWebAppMentionMarkdownChildren(children),
              skills,
            )}
          </p>
        );
      ...
      pre({ node, children, ...props }) {
        ...
        return renderVisuals && inlineVisualKind(language) ? (
          <InlineVisual
