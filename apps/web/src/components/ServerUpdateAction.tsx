import type { EnvironmentId, ServerSelfUpdateCapability } from "@modesto/contracts";
import type { ServerUpdateStage, ServerUpdateState } from "@modesto/client-runtime/state/server";
import {
