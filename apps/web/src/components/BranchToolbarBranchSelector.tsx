...
import type { GitBranch, GitStashInfoResult, GitStatusResult, NativeApi } from "@modesto/contracts";
            ...
            try {
              ...
              if (isStashConflictError(stashError)) {
                ...
                const stashConflictToastId = addBranchRecoveryToast({
                  ...
                  description:
                    "Modesto switched branches and kept your changes in a stash because they could not be restored onto this branch cleanly.",
