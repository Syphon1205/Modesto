import { CheckpointRef, EventId, ThreadId, TurnId, type ModelSlug } from "@modesto/contracts";
...
describe("file undo completion", () => {
  ...
  const summary = {
    ...
    checkpointRef: CheckpointRef.makeUnsafe("refs/modesto/checkpoints/thread-file-undo/turn/2"),
