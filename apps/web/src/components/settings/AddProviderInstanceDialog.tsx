 ...
 * `ProviderInstanceId` in `@modesto/contracts`.
 */
...
// Every built-in driver ships now - kept as an empty, typed array (rather
// than removing the section) so the next genuinely unimplemented driver has
// a ready slot instead of needing this rendering block rebuilt from scratch.
