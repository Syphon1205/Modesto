...
import { MessageId, ThreadMarkerId, type ThreadMarker } from "@modesto/contracts";
...
describe("ChatMarkdown", () => {
  ...
  it("highlights bare important filenames with blue language-aware file chips", async () => {
    const markup = await renderMarkdown(
      "Main changes: package.json, main.ts, ClaudeAdapter.ts, and provider-runtime-stage.ts.",
      "/Users/tanner/Modesto",
    );

    expect(markup).toContain("text-[var(--info-foreground)]");
    expect(markup).toContain('href="/Users/tanner/Modesto/package.json"');
    expect(markup).toContain('href="/Users/tanner/Modesto/main.ts"');
    expect(markup).toContain("package.json");
    expect(markup).toContain("ClaudeAdapter.ts");
    expect(markup).toContain("provider-runtime-stage.ts");
    expect(markup).toContain("npm");
    expect(markup).toContain("typescript");
  });

  it("does not make explicitly missing filenames openable", async () => {
    const markup = await renderMarkdown(
      "**No AGENTS.md exists.** README.md is also missing.",
      "/Users/tanner/TransitNEXT",
    );

    expect(markup).toContain("AGENTS.md");
    expect(markup).toContain("README.md");
    expect(markup).not.toContain('href="/Users/tanner/TransitNEXT/AGENTS.md"');
    expect(markup).not.toContain('href="/Users/tanner/TransitNEXT/README.md"');
  });
