import type { LocalApi, ScopedThreadRef } from "@modesto/contracts";
import { isAtomCommandInterrupted } from "@modesto/client-runtime/state/runtime";
import { isPreviewableUrl } from "@modesto/shared/preview";
