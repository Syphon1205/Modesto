...
import { isTemporaryWorktreeBranch, resolveUniqueModestoBranchName } from "@modesto/shared/git";
...
export function resolveDefaultCreateBranchName(
  ...
  return resolveUniqueModestoBranchName(existingBranchNames, preferredBranch);
}
...
export { resolveAutoFeatureBranchName } from "@modesto/shared/git";
