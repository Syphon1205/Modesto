...
} from "~/components/chat/composerChromeBubbleStyles";
...
interface GitActionsControlProps {
  ...
  // `bubble` is the compact Cursor-style pill above the composer (only when useful).
      ...
      <>
        ...
        >
          <MenuTrigger
            render={
              <button
                ...
                className={cn(
                  COMPOSER_CHROME_BUBBLE_CLASS_NAME,
                  (isGitActionRunning || quickAction.disabled) && "opacity-55",
                )}
          ...
          >
            ...
            <span className="truncate font-normal">{quickAction.label}</span>
            <ChevronDownIcon className={cn(COMPOSER_CHROME_BUBBLE_ICON_CLASS_NAME, "opacity-55")} />
          </MenuTrigger>
