...
import { type ModelSlug, type ProviderKind, type ServerProviderStatus } from "@modesto/contracts";
    ...
    <>
      {visibleAvailableProviderOptions.map((option) => {
        ...
        if (availability.disabled) {
          return (
            <MenuItem key={option.value} onClick={() => openProviderSetup(option.value)}>
              <OptionIcon
                aria-hidden="true"
                className={cn(
