...
import { PANEL_LAYOUT_CONTROLS_HEADER_INSET_CLASS } from "./PanelLayoutControls";
      ...
      {onPopOutChat && !compactChrome ? (
        <div className="flex shrink-0 items-center">
          <Tooltip>
            ...
            <TooltipPopup side="top">Pop out chat</TooltipPopup>
          </Tooltip>
        </div>
      ) : null}
      {regularChat && isServerThread && onStartThread ? (
        <div
          className={cn(
        ...
        >
          <Tooltip>
            ...
            <TooltipPopup side="top">Start a thread</TooltipPopup>
          </Tooltip>
        </div>
      ) : null}
      {regularChat ? null : (
