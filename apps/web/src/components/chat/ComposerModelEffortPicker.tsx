...
import { EFFORT_SLIDER_PICKER_WIDTH_CLASS_NAME } from "./EffortSlider";
  ...
  const triggerStatusLabel = ultrathinkPromptControlled
    ...
    : effortLabel
      ...
      : thinkingEnabled !== null
        ...
        : null;
  const rainbowStatus =
    ultrathinkPromptControlled || effort === "ultracode" || effort === "ultrathink";
      ...
      {triggerStatusLabel ? (
        props.hideStatusLabel ? (
          ...
          <span
            className={cn(
              "shrink-0",
              rainbowStatus ? "ultrathink-word" : COMPOSER_MUTED_ACCENT_TEXT_CLASS_NAME,
            )}
          >
            {triggerStatusLabel}
          </span>
