...
import { CheckpointRef, MessageId, TurnId } from "@modesto/contracts";
...
describe("MessagesTimeline", () => {
  ...
  it("renders a collapsible changed files header with ui-font filenames", async () => {
          ...
          new Map([
            [
              assistantMessageId,
              {
                ...
                checkpointRef: CheckpointRef.makeUnsafe("refs/modesto/checkpoints/thread/turn/1"),
                status: "ready",
                completedAt: "2026-03-17T19:12:30.000Z",
                assistantMessageId,
                files: [
    ...
    expect(markup).toContain("Edited Sidebar.tsx");
    expect(markup).toContain("Undo");
    expect(markup).toContain("Review");
    expect(markup).toContain('data-edited-files-card="true"');
    expect(markup).not.toContain('aria-label="Expand changed files list"');
    expect(markup).toContain("font-system-ui font-medium");
