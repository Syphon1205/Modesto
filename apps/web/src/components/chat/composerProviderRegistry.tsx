...
function getProviderStateFromCapabilities(
  ...
  const rainbowEffortActive =
    ultrathinkActive || promptEffort === "ultracode" || promptEffort === "ultrathink";

  return {
    provider,
    promptEffort,
    modelOptionsForDispatch: normalizedOptions,
    ...(rainbowEffortActive ? { modelPickerIconClassName: "ultrathink-chroma" } : {}),
  };
}
...
const composerProviderRegistry: Record<ProviderKind, ProviderRegistryEntry> = {
  ...
  poolside: {
    getState: (input) => getProviderStateFromCapabilities(input),
    renderTraitsMenuContent: (input) => renderTraitsMenuContentForProvider("poolside", input),
    renderTraitsPicker: (input) => renderTraitsPickerForProvider("poolside", input),
  },
  gemini: {
    getState: (input) => getProviderStateFromCapabilities(input),
