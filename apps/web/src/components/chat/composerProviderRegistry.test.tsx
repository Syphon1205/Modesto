import { type ProviderModelDescriptor, ThreadId } from "@modesto/contracts";
...
describe("getComposerProviderState", () => {
  ...
  it("chroma-shifts the model icon for Ultracode effort", () => {
    const state = getComposerProviderState({
      provider: "claudeAgent",
    ...
    expect(state.promptEffort).toBe("ultracode");
  });
