...
import { PROVIDER_DISPLAY_NAMES, type ServerProviderStatus } from "@modesto/contracts";
  ...
  return (
    <ChatColumnBannerFrame>
      ...
      >
        ...
        {onSetup ? (
          <AlertAction className="mt-2">
            <button
              type="button"
              className="text-xs font-medium text-[var(--notification-fg)] underline-offset-4 hover:underline"
              onClick={onSetup}
            >
