...
import { applyClaudePromptEffortPrefix } from "@modesto/shared/model";
...
import { EffortSlider, EFFORT_SLIDER_PICKER_WIDTH_CLASS_NAME } from "./EffortSlider";
      ...
      {effortLevels.length > 0 ? (
        <>
          ...
          <EffortSlider
            ...
            rainbow={ultrathinkPromptControlled}
            ...
            onValueCommit={handleEffortChange}
          />
        </>
      ) : null}
  ...
  return (
    ...
    >
      ...
      <ComposerPickerMenuPopup
        align="start"
        fixedWidth
        className={effortLevels.length > 0 ? EFFORT_SLIDER_PICKER_WIDTH_CLASS_NAME : undefined}
      >
        <TraitsMenuContent
          provider={provider}
          threadId={threadId}
