...
function SettingsSearchResultRow(props: {
  ...
  const sectionItem = resolveSettingsNavItem(entry.section);
  // Mirrors the project header + nested thread layout: the section label sits above
  // the matched setting as an indented thread-style row.
  return (
    <li>
      <button
        type="button"
      ...
      >
        <SidebarLeadingIcon size="sm" tone="text-inherit">
          <CentralIcon name={sectionItem.icon} className={SETTINGS_SIDEBAR_ICON_CLASS_NAME} />
        </SidebarLeadingIcon>
