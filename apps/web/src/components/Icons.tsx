...
export const MetaIcon: Icon = (props) => {
  const id = useId().replaceAll(":", "");
  const ribbon = `${id}-meta-ribbon`;
  const sheen = `${id}-meta-sheen`;

  return (
    <svg {...props} viewBox="-12 -12 312 215" fill="none">
      <defs>
        <linearGradient
          id={ribbon}
          x1="61"
        ...
        <linearGradient id={sheen} x1="45" y1="139" x2="45" y2="66" gradientUnits="userSpaceOnUse">
...
// Kilo Code's real app icon, from its own repo:
// github.com/Kilo-Org/kilocode/blob/main/packages/kilo-vscode/assets/icons/kilo-dark.svg
// (black square + yellow pixel-art "K" mark - Kilo's brand stays fixed-color
// rather than swapping per app theme, so there's no separate light variant here).
export const KiloIcon: Icon = ({ className, ...props }) => (
  <svg {...props} viewBox="0 0 512 512" fill="none" className={cn("fill-none", className)}>
    <path d="M512 0H0V512H512V0Z" fill="black" />
    <path
      fill="#FAF74F"
      d="M322.783 322.784H278.261V392.747L308.472 422.958H378.435V378.437H322.782L322.783 322.784ZM422.957 308.474L392.746 278.263H322.783V322.784H378.435L378.435 378.437H422.957L422.957 308.474ZM233.739 278.263H189.217V322.784H233.739V278.263ZM89.0435 392.747L119.254 422.958H233.739V378.437H133.565V278.263H89.043L89.0435 392.747ZM372.538 189.217V119.254L342.327 89.0435H278.261V133.565H328.017V189.217H278.261V233.739H422.957V189.217H372.538ZM133.565 89.0435H89.0435V233.739H133.565V183.652H189.218V233.739H233.74V183.652L189.218 139.13H133.565V89.0435ZM233.739 89.0435H189.217L189.218 139.13H233.739V89.0435Z"
    />
  </svg>
);

// Factory Droid's real app icon, ported verbatim from the primary Modesto
// tree's own Icons.tsx (currentColor, so it follows the picker's theme like
// most of the other marks here).
export const DroidIcon: Icon = ({ className, ...props }) => (
  <svg {...props} viewBox="0 0 67 65" fill="none" className={cn("fill-none", className)}>
    <path
      fill="currentColor"
...
/**
 * Kimi / Qwen / Poolside / Devin marks. Kimi and Qwen are single-path
 * glyphs; Poolside and Devin use each vendor's official logomark.
 */

export const PoolsideIcon: Icon = ({ className, ...props }) => (
  <svg viewBox="0 0 128 128" fill="none" className={className} {...props}>
    <path
