  ...
  it("keeps local chats compact", () => {
    const metadata = resolveThreadHoverCardMetadata({
      ...
      project: {
        name: "modesto",
        folderName: "modesto",
        cwd: "/Users/me/Developer/modesto",
      },
    });

    expect(metadata).toEqual({
      projectName: "modesto",
      projectCwd: "/Users/me/Developer/modesto",
...
describe("add-project error helpers", () => {
  ...
  it("explains root-absolute add-project paths that probably missed the home directory", () => {
    expect(
      describeAddProjectError("Failed to create project directory: /Developer/Testing/modesto"),
