...
import { encodeConnectAuthCode, readConnectAuthorizeRequest } from "@modesto/shared/connectAuth";
...
export function ConnectCliAuthorizeSurface() {
  ...
  const openSignIn = useCallback(() => {
    ...
    void navigate({
      to: "/sign-in",
      search: { redirect: connectCliSignInRedirectUrl(request, window.location.href) },
    });
  }, [navigate, request]);
