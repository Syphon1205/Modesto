...
import { type FilesystemBrowseResult, type ProviderKind } from "@modesto/contracts";
...
export type ImportProviderKind = Extract<
  ProviderKind,
  "codex" | "claudeAgent" | "cursor" | "gemini" | "grok" | "droid" | "kilo" | "opencode" | "pi"
>;
    ...
    importProvider === "claudeAgent"
      ...
      : importProvider === "cursor"
        ...
        : importProvider === "gemini"
          ? "Paste a Gemini session id"
          : importProvider === "grok"
            ? "Paste a Grok session id"
                ...
                <p className="text-xs text-muted-foreground">
                  {importProvider === "claudeAgent"
                    ...
                    : importProvider === "cursor"
                      ...
                      : importProvider === "gemini"
                        ? "Gemini resumes a locally persisted session by session id."
                        : importProvider === "grok"
                          ? "Grok resumes a locally persisted session by session id."
                          : importProvider === "droid"
                            ? "Droid resumes a locally persisted session by session id."
                            : importProvider === "kilo"
                              ? "Kilo resumes a persisted session by session id."
                              : importProvider === "opencode"
                                ? "OpenCode resumes a persisted session by session id."
                                : importProvider === "pi"
                                  ? "Pi resumes a local session file by path."
