import type { ProviderKind, ProviderModelDescriptor } from "@modesto/contracts";
import { getModelCapabilities, hasEffortLevel, trimOrNull } from "@modesto/shared/model";
