...
describe("parseBareComposerLink", () => {
  it("returns the URL when the whole text is one bare link", () => {
    expect(parseBareComposerLink("https://github.com/Syphon1205/modesto")).toBe(
...
describe("describeLinkChip", () => {
  it("shortens GitHub pull request URLs to owner/repo#number", () => {
    expect(describeLinkChip("https://github.com/Syphon1205/modesto/pull/155")).toEqual({
      label: "Syphon1205/modesto#155",
      isGitHub: true,
    });
  });
