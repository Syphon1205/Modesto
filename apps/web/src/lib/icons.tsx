...
export const ActivityIcon = adaptIcon(IconActivity);
export const UsersIcon = adaptIcon(IconUsers);
...
export const CornerLeftUpIcon = adaptIcon(IconCornerLeftUp);
export const CursorTextIcon = adaptIcon(IconCursorText);
export const FilterIcon = adaptIcon(IconFilter);
export const FolderPlusIcon = adaptIcon(IconFolderPlus);
export const HandRaisedIcon = adaptIcon(IconHandStop);
export const PlusMinusIcon = adaptIcon(IconPlusMinus);
...
export const ReviewIcon = centralIconWrapper("review");
...
export const InstagramIcon: LucideIcon = (props) => (
  <SiInstagram className={props.className} style={props.style} />
);
export const GitPullRequestIcon = centralIconWrapper("pull-request");
// Brand/logo glyphs with no Tabler equivalent — thin react-icons passthroughs,
// same shape as GitHubIcon above, kept behind the shared icon API.
export const CanvaIcon: LucideIcon = (props) => (
  <SiCanva className={props.className} style={props.style} />
);
export const FigmaIcon: LucideIcon = (props) => (
  <SiFigma className={props.className} style={props.style} />
);
export const GmailIcon: LucideIcon = (props) => (
  <SiGmail className={props.className} style={props.style} />
);
export const GoogleCalendarIcon: LucideIcon = (props) => (
  <SiGooglecalendar className={props.className} style={props.style} />
);
export const GoogleDriveIcon: LucideIcon = (props) => (
  <SiGoogledrive className={props.className} style={props.style} />
);
export const HuggingFaceIcon: LucideIcon = (props) => (
  <SiHuggingface className={props.className} style={props.style} />
);
export const LinearAppIcon: LucideIcon = (props) => (
  <SiLinear className={props.className} style={props.style} />
);
export const LinkedInIcon: LucideIcon = (props) => (
  <FaLinkedinIn className={props.className} style={props.style} />
);
export const NotionIcon: LucideIcon = (props) => (
  <SiNotion className={props.className} style={props.style} />
);
export const RedditIcon: LucideIcon = (props) => (
  <SiReddit className={props.className} style={props.style} />
);
export const SlackIcon: LucideIcon = (props) => (
  <SiSlack className={props.className} style={props.style} />
);
export const StripeIcon: LucideIcon = (props) => (
  <SiStripe className={props.className} style={props.style} />
);
export const VercelIcon: LucideIcon = (props) => (
  <SiVercel className={props.className} style={props.style} />
);
export const XSocialIcon: LucideIcon = (props) => (
  <SiX className={props.className} style={props.style} />
);
...
export const TelescopeIcon = adaptIcon(IconTelescope);
