...
import { stripInlineVisualInstructions } from "../studio/inlineVisualPrompt";
...
export function deriveDisplayedUserMessageState(prompt: string): DisplayedUserMessageState {
  ...
  return {
    visibleText: stripInlineVisualInstructions(extractedTerminal.promptText),
    copyText: stripInlineVisualInstructions(prompt),
