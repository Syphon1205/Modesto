...
import type { ProviderKind, ServerProviderStatus, ServerSettings } from "@modesto/contracts";
...
function serverSettings(overrides: Partial<ServerSettings["providers"]> = {}): ServerSettings {
  ...
  return {
    ...
    providers: {
      ...
      poolside: { ...provider, binaryPath: "pool" },
...
describe("getVisibleProviderUpdateStatuses", () => {
  it("excludes providers hidden from Modesto so unchecked providers do not nag", () => {
