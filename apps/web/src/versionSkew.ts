import type { EnvironmentId, ServerConfig, ServerSelfUpdateCapability } from "@modesto/contracts";
...
export const VERSION_MISMATCH_DISMISSALS_STORAGE_KEY = "modesto:version-mismatch-dismissals:v1";
...
export function resolveVersionMismatch(
  ...
  return {
    ...
    hint: "Version mismatch. Try syncing the client and server to the same Modesto version.",
  };
}
