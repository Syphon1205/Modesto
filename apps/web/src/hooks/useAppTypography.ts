...
const TERMINAL_THEME_ATTRIBUTE = "data-terminal-theme";
...
export function useAppTypography() {
  ...
  useEffect(() => {
    ...
    document.documentElement.setAttribute(TERMINAL_THEME_ATTRIBUTE, settings.terminalTheme);
    ...
    return () => {
      ...
      rootStyle.removeProperty(TERMINAL_FONT_FAMILY_CSS_VARIABLE);
      document.documentElement.removeAttribute(TERMINAL_THEME_ATTRIBUTE);
    };
  }, [
