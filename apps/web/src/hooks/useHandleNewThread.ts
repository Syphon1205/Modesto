...
import { DEFAULT_RUNTIME_MODE, type ScopedProjectRef, type ThreadId } from "@modesto/contracts";
...
import { resolveDefaultThreadEnvMode } from "@modesto/shared/threadEnvMode";
import { readThreadShell, useProjects, useThread } from "../state/entities";
import { usePrimaryEnvironmentId } from "../state/environments";
import { resolveNewDraftStartFromOrigin, UNSCOPED_CHAT_PROJECT_ID } from "../lib/chatThreadActions";
  ...
  return useCallback(
    (
      ...
      options?: {
        ...
        /** Presentation mode for the conversation opened by this action. */
      ...
      if (emptyStoredDraftThread) {
        return (async () => {
          ...
          applyConversationMode(emptyStoredDraftThread.draftId);
          const opened = {
      ...
      if (
        ...
        applyConversationMode(currentRouteTarget.draftId);
      ...
      return (async () => {
        ...
        if (
          ...
          applyConversationMode(racedDraft.draftId);
          await router.navigate({
            to: "/draft/$draftId",
...
export function useHandleNewThread() {
  ...
  return {
    ...
    defaultProjectRef: orderedProjects[0]
      ...
      : null,
    unscopedChatProjectRef: primaryEnvironmentId
      ? scopeProjectRef(primaryEnvironmentId, UNSCOPED_CHAT_PROJECT_ID)
      : null,
    handleNewThread,
    routeThreadRef,
  };
