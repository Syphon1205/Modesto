...
export const PERSISTED_STATE_KEY = "modesto:ui-state:v1";
const THREAD_CHANGED_FILES_EXPANSION_VERSION = 1;
const LEGACY_PERSISTED_STATE_KEYS = [
  "modesto:renderer-state:v8",
  "modesto:renderer-state:v7",
  "modesto:renderer-state:v6",
  "modesto:renderer-state:v5",
  "modesto:renderer-state:v4",
  "modesto:renderer-state:v3",
