...
} from "@modesto/client-runtime/platform";
import {
...
import { bootstrapRemoteBearerSession } from "@modesto/client-runtime/authorization";
import { fetchRemoteEnvironmentDescriptor } from "@modesto/client-runtime/environment";
import { managedRelayAccountChanges, managedRelaySessionAtom } from "@modesto/client-runtime/relay";
import { EnvironmentRpcRequestObserver } from "@modesto/client-runtime/rpc";
import {
...
function clientMetadata() {
  ...
  return {
    label: desktop ? "Modesto Desktop" : "Modesto Web",
