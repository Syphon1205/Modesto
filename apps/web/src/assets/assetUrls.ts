...
import { resolveAssetUrl } from "@modesto/client-runtime/state/assets";
import type { AssetResource, EnvironmentId } from "@modesto/contracts";
...
export { resolveAssetUrl } from "@modesto/client-runtime/state/assets";
