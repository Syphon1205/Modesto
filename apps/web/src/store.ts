...
import { resolveThreadBranchRegressionGuard } from "@modesto/shared/git";
import {
  addPinnedMessage,
  removePinnedMessage,
...
import { normalizeWorkspaceRootForComparison } from "@modesto/shared/threadWorkspace";
...
import { deriveThreadSummaryMetadata } from "@modesto/shared/threadSummary";
...
const PERSISTED_STATE_KEY = "modesto:renderer-state:v8";
