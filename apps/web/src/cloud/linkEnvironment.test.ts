...
import { RelayWebClientId } from "@modesto/contracts/relay";
...
beforeEach(() => {
  vi.clearAllMocks();
  vi.stubEnv("VITE_MODESTO_RELAY_URL", "https://relay.example.test");
