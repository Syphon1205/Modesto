...
export const SETTINGS_SEARCH_ENTRIES: readonly SettingsSearchEntry[] = [
  ...
  // ── Code Review ────────────────────────────────────────────────────────────
  {
    id: "code-review:provider",
    section: "codeReview",
    title: "Active provider",
    keywords: "Modesto Review Codex Cursor runtime code review",
  },
  {
    id: "code-review:runtime",
    section: "codeReview",
    title: "Model runtime",
    keywords: "model runtime codex claude depth quick standard deep",
  },
  {
    id: "code-review:scope",
    section: "codeReview",
    title: "Default scope",
    keywords: "current file changed files selected repository pull request staged",
  },
  {
    ...
    keywords:
      "performance architecture test coverage fix suggestions instructions AGENTS CONTRIBUTING",
  },
  {
  ...
  // ── Appearance ───────────────────────────────────────────────────────────────
  {
    ...
    section: "appearance",
    title: "Theme",
    keywords: "Choose how Modesto looks across the app. dark light system color",
  },
  {
  ...
  // ── Fonts ────────────────────────────────────────────────────────────────────
  {
    id: "fonts:dark-ui-font",
    section: "fonts",
    title: "Dark theme UI font",
    keywords: "Interface font family used by the dark theme.",
    target: null,
  },
  {
    id: "fonts:dark-code-font",
    section: "fonts",
    title: "Dark theme code font",
    keywords: "Monospace code font family used by the dark theme.",
    target: null,
  },
  {
    id: "fonts:light-ui-font",
    section: "fonts",
    title: "Light theme UI font",
    keywords: "Interface font family used by the light theme.",
    target: null,
  },
  {
    id: "fonts:light-code-font",
    section: "fonts",
    title: "Light theme code font",
    keywords: "Monospace code font family used by the light theme.",
    target: null,
  },
  {
    id: "fonts:base-font-size",
    section: "fonts",
  ...
  // ── Updates ───────────────────────────────────────────────────────────────────
  {
    id: "updates:current-version",
    section: "updates",
    title: "Version",
    keywords: "Installed Modesto app build version",
  },
  ...
  // ── Keyboard Shortcuts ────────────────────────────────────────────────────────
  {
    ...
    keywords:
      "Every keyboard shortcut available in Modesto, grouped by context. keybindings hotkeys key combo cmd ctrl reference",
    target: null,
  },
  ...
  // ── Worktrees ─────────────────────────────────────────────────────────────────
  {
    ...
    keywords: "Review and clean up the worktrees created by Modesto. git branch remove",
    target: null,
  },
  ...
  },
  {
    ...
    keywords: "Update installed provider tools that Modesto can safely update. upgrade cli",
  },
  {
  ...
  // ── About ─────────────────────────────────────────────────────────────────────
  {
    ...
    section: "about",
    title: "About Modesto",
    keywords: "Current application version Milpitas product information",
  },
  {
    id: "about:community",
    section: "about",
    title: "GitHub and Instagram",
    keywords: "community social source repository trymodesto",
    target: null,
  },
  {
    id: "about:resources",
    ...
    keywords: "documentation release history what's new release notes",
    target: null,
  },
  {
    id: "about:feedback",
    ...
    keywords: "issue feedback enhancement support",
    target: null,
  },
  // ── Cursor-parity sections ────────────────────────────────────────────────
  {
    id: "agents:default-provider",
    section: "agents",
    title: "Default provider",
    keywords: "agent defaults provider new chat",
  },
  {
    id: "agents:launch-args",
    section: "agents",
    title: "Launch arguments",
    keywords: "claude launch args agent cli flags",
  },
  {
    id: "cloudAgents:openclaw",
    section: "cloudAgents",
    title: "OpenClaw",
    keywords: "cloud agents remote openclaw gateway allowed providers coding agents",
    target: null,
  },
  {
    id: "cloudAgents:providers",
    section: "cloudAgents",
    title: "Allowed coding agents",
    keywords: "cloud agents providers enabled codex claude cursor gemini openclaw",
    target: null,
  },
  {
    id: "toolsMcps:servers",
    section: "toolsMcps",
    title: "Codex MCP servers",
    keywords: "mcp tools servers config.toml enable disable",
    target: null,
  },
  {
    id: "hooks:lifecycle",
    section: "hooks",
    title: "Codex hooks",
    keywords: "hooks UserPromptSubmit Stop lifecycle command",
    target: null,
  },
  {
    id: "skills:rules",
    section: "skills",
    title: "Codex rules",
    keywords: "rules skills subagents agents.md guidance",
    target: null,
  },
  {
    id: "browserNetwork:bridge",
    section: "browserNetwork",
    title: "Desktop browser bridge",
    keywords: "browser network chromium panel environment repository pull request",
  },
  {
    id: "tab:preferred-editor",
    section: "tab",
    title: "Open files with",
    keywords: "tab editor preferred cursor vscode open in editor",
  },
  {
    id: "indexing:rebuild",
    section: "indexing",
    title: "Rebuild indexes",
    keywords: "indexing rebuild project indexes repair state",
  },
  {
    id: "plugins:library",
    section: "plugins",
    title: "Plugins",
    keywords: "plugins marketplace install uninstall extensions",
    target: null,
  },
] as const;
...
SETTINGS_SECTION_LABEL_BY_ID.set("gitPrs", "Git & PRs");
SETTINGS_SECTION_LABEL_BY_ID.set("rulesSkills", "Rules, Skills, Subagents");
