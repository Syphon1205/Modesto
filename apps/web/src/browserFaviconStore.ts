...
import type { DesktopPreviewFavicon, ScopedProjectRef, ScopedThreadRef } from "@modesto/contracts";
...
const BROWSER_FAVICON_STORAGE_KEY = "modesto:browser-favicons:v1";
