...
import { WelcomeSetupScreen } from "../components/welcome/WelcomeSetupScreen";
import { ProviderUpdateLaunchNotification } from "../components/ProviderUpdateLaunchNotification";
import { AppUpdateNotification } from "../components/updates/AppUpdateNotification";
import { ProviderModelReleaseNotification } from "../components/updates/ProviderModelReleaseNotification";
    ...
    <ToastProvider>
      <UpdatesToastProvider>
        <AnchoredToastProvider>
          ...
          {/* First run: a full-screen welcome covering appearance, the agent
            roster and the first project. Opens once per setup revision, and
            Settings → General re-launches it. */}
          <WelcomeSetupScreen />
          <ConfirmDialogHost />
          ...
          {/* Update news, all of it bottom-right: the app's own build, the
            provider CLIs, and models a provider has just started offering. */}
          <AppUpdateNotification />
          {primaryEnvironmentAuthenticated ? <ProviderModelReleaseNotification /> : null}
          {appShell}
