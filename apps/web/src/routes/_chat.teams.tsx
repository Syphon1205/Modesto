    ...
    <RouteInsetSurface>
      ...
      >
        ...
        <main className="flex min-h-0 flex-1 items-center justify-center overflow-y-auto px-6 py-12">
          <WorkspaceComingSoon
            name="Teams"
            heading="Hand off a complete outcome"
            description="Teams will coordinate parallel agents, connected files, and apps from one shared task. It is not available yet, so starting work here will never open a Code chat."
            tone="blue"
          />
        </main>
      </div>
