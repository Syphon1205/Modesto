...
export const CODE_THEME_OPTIONS: readonly CodeThemeOption[] = [
  ...
  { id: "cursor", label: "Cursor", variants: ["light", "dark"] },
  { id: "modesto", label: "Modesto", variants: ["light", "dark"] },
...
export const DEFAULT_THEME_STATE: ThemeState = {
  chromeThemes: {
    dark: getCodeThemeSeed("cursor", "dark"),
    light: getCodeThemeSeed("cursor", "light"),
  },
  codeThemeIds: {
    dark: "cursor",
    light: "cursor",
