...
import type { ProjectId, ProviderKind, ThreadId } from "@modesto/contracts";
import { isProviderKind } from "./providerOrdering";

const EDITOR_VIEW_STATE_STORAGE_KEY = "modesto.editor.viewStateByThreadId";
const EDITOR_RAIL_CHAT_TABS_STORAGE_KEY = "modesto.editor.railChatTabsByProjectId";
