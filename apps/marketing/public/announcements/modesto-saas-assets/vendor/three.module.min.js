...
import {
  ...
  OneMinusSrcColorFactor as Ie,
  DstAlphaFactor as ye,
  ...
  RGFormat as Nt,
  RGIntegerFormat as Ot,
  RGBAIntegerFormat as Ft,
  RGB_S3TC_DXT1_Format as Bt,
  RGBA_S3TC_DXT1_Format as Ht,
  RGBA_S3TC_DXT3_Format as Gt,
  RGBA_S3TC_DXT5_Format as Vt,
  RGB_PVRTC_4BPPV1_Format as zt,
  RGB_PVRTC_2BPPV1_Format as kt,
  RGBA_PVRTC_4BPPV1_Format as Wt,
  RGBA_PVRTC_2BPPV1_Format as Xt,
  RGB_ETC1_Format as Yt,
  RGB_ETC2_Format as Kt,
  RGBA_ETC2_EAC_Format as qt,
  RGBA_ASTC_4x4_Format as jt,
  RGBA_ASTC_5x4_Format as Zt,
  RGBA_ASTC_5x5_Format as $t,
  RGBA_ASTC_6x5_Format as Qt,
  RGBA_ASTC_6x6_Format as Jt,
  RGBA_ASTC_8x5_Format as en,
  RGBA_ASTC_8x6_Format as tn,
  RGBA_ASTC_8x8_Format as nn,
  RGBA_ASTC_10x5_Format as rn,
  RGBA_ASTC_10x6_Format as an,
  RGBA_ASTC_10x8_Format as on,
  RGBA_ASTC_10x10_Format as sn,
  RGBA_ASTC_12x10_Format as ln,
  RGBA_ASTC_12x12_Format as cn,
  RGBA_BPTC_Format as dn,
  RGB_BPTC_SIGNED_Format as un,
  RGB_BPTC_UNSIGNED_Format as fn,
  RED_RGTC1_Format as pn,
  SIGNED_RED_RGTC1_Format as mn,
  RED_GREEN_RGTC2_Format as hn,
  SIGNED_RED_GREEN_RGTC2_Format as _n,
  ExternalTexture as gn,
  EventDispatcher as vn,
  ArrayCamera as En,
  WebXRController as Sn,
  RAD2DEG as Tn,
  createCanvasElement as Mn,
  SRGBColorSpace as xn,
  REVISION as Rn,
  WebGLCoordinateSystem as An,
  probeAsync as bn,
    ...
    addToRenderList: function (t, n) {
      ...
      r && (r.isCubeTexture || r.mapping === a)
        ? (void 0 === T &&
            ...
            u.update(T)),
          In.copy(n.backgroundRotation),
          (In.x *= -1),
          (In.y *= -1),
          (In.z *= -1),
          r.isCubeTexture && !1 === r.isRenderTargetTexture && ((In.y *= -1), (In.z *= -1)),
          ...
          T.material.uniforms.backgroundRotation.value.setFromMatrix4(yn.makeRotationFromEuler(In)),
          (T.material.toneMapped = p.getTransfer(r.colorSpace) !== m),
          (x === r && R === r.version && A === e.toneMapping) ||
            ((T.material.needsUpdate = !0), (x = r), (R = r.version), (A = e.toneMapping)),
          T.layers.enableAll(),
        ...
        : r &&
          ...
          (x === r && R === r.version && A === e.toneMapping) ||
            ((S.material.needsUpdate = !0), (x = r), (R = r.version), (A = e.toneMapping)),
          S.layers.enableAll(),
          ...
          (function (n, r, i, a) {
            ...
            for (const r in s) {
              ...
              if (i.location >= 0) {
                ...
                if (
                  (void 0 === s &&
                    ("instanceMatrix" === r && n.instanceMatrix && (s = n.instanceMatrix),
                    "instanceColor" === r && n.instanceColor && (s = n.instanceColor)),
                  void 0 !== s)
                ) {
                  ...
                  if (s.isInterleavedBufferAttribute) {
                    ...
                    } else for (let e = 0; e < i.locationSize; e++) u(i.location + e);
    ...
    if (0 !== a) {
      if (((o = c.value), !0 !== i || null === o)) {
        ...
        for (let t = 0, n = r; t !== a; ++t, n += 4)
          (s.copy(e[t]).applyMatrix4(i, l), s.normal.toArray(o, n), (o[n + 3] = s.constant));
      }
...
class Jn {
  ...
  _sceneToCubeUV(e, t, n, r, i) {
    ...
    for (let t = 0; t < 6; t++) {
      const n = t % 3;
      0 === n
        ? (a.up.set(0, l[t], 0), a.position.set(i.x, i.y, i.z), a.lookAt(i.x + d[t], i.y, i.z))
        : 1 === n
          ? (a.up.set(0, 0, l[t]), a.position.set(i.x, i.y, i.z), a.lookAt(i.x, i.y + d[t], i.z))
          : (a.up.set(0, l[t], 0), a.position.set(i.x, i.y, i.z), a.lookAt(i.x, i.y, i.z + d[t]));
...
function sr(e, t, n, r) {
  ...
  return {
    get: function (e, t) {
      return (
        !0 === i[t.id] || (t.addEventListener("dispose", o), (i[t.id] = !0), n.memory.geometries++),
        t
      );
    },
    update: function (n) {
    ...
    update: function (o, s, l) {
      ...
      if (void 0 === f || f.count !== u) {
        ...
        let S = s.attributes.position.count * E,
          M = 1;
        S > n.maxTextureSize && ((M = Math.ceil(S / n.maxTextureSize)), (S = n.maxTextureSize));
      ...
      if (!0 === o.isInstancedMesh && null !== o.morphTexture)
        ...
        let y = 0;
        for (let O = 0; O < c.length; O++) y += c[O];
        const N = s.morphTargetsRelative ? 1 : 1 - y;
...
function Ri() {
  ...
  return [
    ...
    `\tconst vec3 weights = vec3( ${xi.x.toFixed(4)}, ${xi.y.toFixed(4)}, ${xi.z.toFixed(4)} );`,
...
function Oi(e, t, n, r) {
  ...
  function R(t) {
    if (e.debug.checkShaderErrors) {
      const n = i.getProgramInfoLog(_) || "",
        r = i.getShaderInfoLog(M) || "",
        a = i.getShaderInfoLog(x) || "",
        o = n.trim(),
        s = r.trim(),
        l = a.trim();
      let c = !0,
...
function Gi(e, t, n, r, i, o, s) {
  ...
  return {
    getParameters: function (o, l, f, S, T) {
      ...
      const L = x.morphAttributes.position || x.morphAttributes.normal || x.morphAttributes.color,
      ...
      if (
        ...
        ((U = o.vertexShader),
          (w = o.fragmentShader),
          d.update(o),
          (I = d.getVertexShaderID(o)),
          (y = d.getFragmentShaderID(o)));
      ...
      const Ce = {
        ...
        outputColorSpace:
          null === O ? e.outputColorSpace : !0 === O.isXRRenderTarget ? O.texture.colorSpace : F,
        ...
        displacementMapUv: q && E(o.displacementMap.channel),
        emissiveMapUv: j && E(o.emissiveMap.channel),
        ...
        vertexAlphas:
          !0 === o.vertexColors && !!x.attributes.color && 4 === x.attributes.color.itemSize,
        ...
        decodeVideoTextureEmissive:
          j && !0 === o.emissiveMap.isVideoTexture && p.getTransfer(o.emissiveMap.colorSpace) === m,
      ...
      return (
        !1 === t.isRawShaderMaterial &&
          ...
          (function (e, t) {
            ...
            t.reversedDepthBuffer && l.enable(4);
...
function Qi(e, n, r) {
  ...
  function x(t, r) {
    ...
    (g.defines.VSM_SAMPLES !== t.blurSamples &&
      ...
      (g.needsUpdate = !0),
      (v.needsUpdate = !0)),
      null === t.mapPass && (t.mapPass = new y(a.x, a.y)),
  ...
  function R(t, n, r, i) {
    ...
    if (void 0 !== o) a = o;
      ...
      void 0 === r && ((r = {}), (p[e] = r));
      let i = r[t];
      (void 0 === i && ((i = a.clone()), (r[t] = i), n.addEventListener("dispose", b)), (a = i));
    }
    if (
      ((a.visible = n.visible),
  ...
  this.render = function (t, n, r) {
    ...
    for (let o = 0, l = t.length; o < l; o++) {
      ...
      if (
        ...
        s.copy(c.mapSize),
        (a.x > m || a.y > m) &&
          (a.x > m && ((s.x = Math.floor(m / h.x)), (a.x = s.x * h.x), (c.mapSize.x = s.x)),
          a.y > m && ((s.y = Math.floor(m / h.y)), (a.y = s.y * h.y), (c.mapSize.y = s.y))),
        null === c.map || !0 === f || !0 === p)
      ) {
        const e = this.type !== J ? { minFilter: Te, magFilter: Te } : {};
        (null !== c.map && c.map.dispose(),
          (c.map = new y(a.x, a.y, e)),
...
function ea(e, t) {
  ...
  -1 !== y.indexOf("WebGL")
    ? ((w = parseFloat(/^WebGL (\d)/.exec(y)[1])), (D = w >= 1))
    : -1 !== y.indexOf("OpenGL ES") &&
      ((w = parseFloat(/^OpenGL ES (\d)/.exec(y)[1])), (D = w >= 2));
  let N = null,
    O = {};
    ...
    if (t !== I) {
      if ((!1 === m && (W(e.BLEND), (m = !0)), t === $e))
        ((a = a || n),
          ...
          (r === g && i === v && o === S && s === T) ||
            (e.blendFuncSeparate(K[r], K[i], K[o], K[s]), (g = r), (v = i), (S = o), (T = s)),
          (!1 !== l.equals(M) && c === x) || (e.blendColor(l.r, l.g, l.b, c), M.copy(l), (x = c)),
          (h = t),
          (R = !1));
      else if (t !== h || d !== R) {
        if (((_ === Ae && E === Ae) || (e.blendEquation(e.FUNC_ADD), (_ = Ae), (E = Ae)), d))
          switch (t) {
            case pe:
        ...
        ((g = null), (v = null), (S = null), (T = null), M.set(0, 0, 0), (x = 0), (h = t), (R = d));
      }
...
function ta(e, n, r, i, a, o, s) {
  ...
  function A(t, r, i, a, o = !1) {
    ...
    if (
      ...
      r === e.RGBA_INTEGER &&
        ...
        i === e.INT && (s = e.RGBA32I)),
      r === e.RGB &&
        (i === e.UNSIGNED_INT_5_9_9_9_REV && (s = e.RGB9_E5),
        i === e.UNSIGNED_INT_10F_11F_11F_REV && (s = e.R11F_G11F_B10F)),
      r === e.RGBA)
    ) {
    ...
    (t.removeEventListener("dispose", L),
      (function (e) {
        ...
        if (r) {
          ...
          (i.usedTimes--, 0 === i.usedTimes && U(e), 0 === Object.keys(r).length && h.delete(n));
        }
        i.remove(e);
      })(t),
  ...
  function w(t, n) {
    ...
    if (
      ...
      if (null === e)
        ...
        if (!1 !== e.complete) return void V(a, t, n);
  ...
  const I = { [at]: e.REPEAT, [it]: e.CLAMP_TO_EDGE, [rt]: e.MIRRORED_REPEAT },
    y = {
      [Te]: e.NEAREST,
  ...
  function O(t, r) {
    if (
      ...
      e.texParameteri(t, e.TEXTURE_WRAP_S, I[r.wrapS]),
      e.texParameteri(t, e.TEXTURE_WRAP_T, I[r.wrapT]),
      (t !== e.TEXTURE_3D && t !== e.TEXTURE_2D_ARRAY) ||
        e.texParameteri(t, e.TEXTURE_WRAP_R, I[r.wrapR]),
      e.texParameteri(t, e.TEXTURE_MAG_FILTER, y[r.magFilter]),
      e.texParameteri(t, e.TEXTURE_MIN_FILTER, y[r.minFilter]),
      r.compareFunction &&
  ...
  function H(t, n) {
    ...
    if (o !== t.__cacheKey) {
      (void 0 === a[o] &&
        ((a[o] = { texture: e.createTexture(), usedTimes: 0 }), s.memory.textures++, (r = !0)),
        a[o].usedTimes++);
      ...
      if (n.isDepthTexture)
        ...
        if (T.length > 0) {
          ...
          for (let t = 0, n = T.length; t < n; t++)
            ((g = T[t]),
              R
                ? P && r.texSubImage2D(e.TEXTURE_2D, t, 0, 0, g.width, g.height, h, _, g.data)
                : r.texImage2D(e.TEXTURE_2D, t, S, g.width, g.height, 0, h, _, g.data));
          n.generateMipmaps = !1;
        } else
          R
            ? (L && r.texStorage2D(e.TEXTURE_2D, U, S, m.width, m.height),
              P &&
                (function (t, n, i, a) {
                  ...
                  if (0 === o.length)
                    r.texSubImage2D(e.TEXTURE_2D, 0, 0, 0, n.width, n.height, i, a, n.data);
                  else {
                    ...
                    for (let e = 1; e < o.length; e++) {
                      const t = o[s],
                        r = o[e],
                        i = t.start + t.count,
                        a = G(r.start, n.width, 4),
                        l = G(t.start, n.width, 4);
                      r.start <= i + 1 && a === l && G(r.start + r.count - 1, n.width, 4) === a
                    ...
                    for (let t = 0, s = o.length; t < s; t++) {
                      ...
                      (e.pixelStorei(e.UNPACK_SKIP_PIXELS, d),
                        ...
                        r.texSubImage2D(e.TEXTURE_2D, 0, d, u, f, p, i, a, n.data));
                    }
                    (t.clearUpdateRanges(),
        ...
        if (n.isCompressedArrayTexture) {
          R && L && r.texStorage3D(e.TEXTURE_2D_ARRAY, U, S, T[0].width, T[0].height, m.depth);
            ...
            ((g = T[t]),
              n.format !== M
                ? null !== h
                  ? R
                    ? P &&
                      r.compressedTexSubImage2D(e.TEXTURE_2D, t, 0, 0, g.width, g.height, h, g.data)
                    : r.compressedTexImage2D(e.TEXTURE_2D, t, S, g.width, g.height, 0, g.data)
                  : console.warn(
                      "THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()",
                    )
                : R
        ...
        if (R) {
          if ((L && r.texStorage3D(e.TEXTURE_2D_ARRAY, U, S, m.width, m.height, m.depth), P))
            if (n.layerUpdates.size > 0) {
              ...
              for (const i of n.layerUpdates) {
                ...
                r.texSubImage3D(e.TEXTURE_2D_ARRAY, 0, 0, 0, i, m.width, m.height, 1, h, _, n);
              }
              n.clearLayerUpdates();
            } else
              r.texSubImage3D(
        ...
        } else r.texImage3D(e.TEXTURE_2D_ARRAY, 0, S, m.width, m.height, m.depth, 0, h, _, m.data);
      else if (n.isData3DTexture)
        R
          ? (L && r.texStorage3D(e.TEXTURE_3D, U, S, m.width, m.height, m.depth),
            P &&
              r.texSubImage3D(e.TEXTURE_3D, 0, 0, 0, 0, m.width, m.height, m.depth, h, _, m.data))
        ...
        if (L)
          if (R) r.texStorage2D(e.TEXTURE_2D, U, S, m.width, m.height);
            ...
            let t = m.width,
              n = m.height;
            for (let i = 0; i < U; i++)
              (r.texImage2D(e.TEXTURE_2D, i, S, t, n, 0, h, _, null), (t >>= 1), (n >>= 1));
          }
      } else if (T.length > 0) {
        if (R && L) {
          const t = Q(T[0]);
  ...
  function z(t, n, a, s, c, d) {
    ...
    (r.bindFramebuffer(e.FRAMEBUFFER, t),
      Z(n)
        ? l.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER, s, c, h.__webglTexture, 0, j(n))
        : (c === e.TEXTURE_2D ||
  ...
  function W(t, n) {
    ...
    if ((r.bindFramebuffer(e.FRAMEBUFFER, t), !n.depthTexture || !n.depthTexture.isDepthTexture))
  ...
  function X(t) {
    ...
    if (t.depthTexture && !n.__autoAllocateDepthBuffer) {
      ...
      e && e.length > 0 ? W(n.__webglFramebuffer[0], t) : W(n.__webglFramebuffer, t);
    } else if (a) {
      ...
      for (let i = 0; i < 6; i++)
        if (
          ...
          ((n.__webglDepthbuffer[i] = e.createRenderbuffer()), k(n.__webglDepthbuffer[i], t, !1));
        else {
      ...
      if (
        ...
        ((n.__webglDepthbuffer = e.createRenderbuffer()), k(n.__webglDepthbuffer, t, !1));
      else {
        const r = t.stencilBuffer ? e.DEPTH_STENCIL_ATTACHMENT : e.DEPTH_ATTACHMENT,
              ...
              if ((O(e.TEXTURE_CUBE_MAP, n), f)) {
                ...
                for (let t = 0; t < 6; t++)
                  if (m) {
                    ...
                    R
                      ? L && r.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X + t, 0, 0, 0, g, S, h[t])
                      : r.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X + t, 0, T, g, S, h[t]);
                    for (let n = 0; n < P.length; n++) {
                      const i = P[n];
                      R
                        ? L &&
        ...
        if (t.samples > 0 && !1 === Z(t)) {
          ...
          (e.bindRenderbuffer(e.RENDERBUFFER, null),
            t.depthBuffer &&
              ...
              k(a.__webglDepthRenderbuffer, t, !0)),
            r.bindFramebuffer(e.FRAMEBUFFER, null));
        }
      }
      if (d) {
        ...
        for (let n = 0, o = c.length; n < o; n++) {
          ...
          ((t.isWebGL3DRenderTarget || t.isWebGLArrayRenderTarget) &&
            ...
            r.bindTexture(l, s.__webglTexture),
            O(l, o),
            z(a.__webglFramebuffer, t, o, e.COLOR_ATTACHMENT0 + n, l, 0),
            E(o) && x(l));
        }
        r.unbindTexture();
      } else {
        ...
        if (
          ...
          for (let r = 0; r < n.mipmaps.length; r++)
            z(a.__webglFramebuffer[r], t, n, e.COLOR_ATTACHMENT0, i, r);
        else z(a.__webglFramebuffer, t, n, e.COLOR_ATTACHMENT0, i, 0);
          ...
          for (let r = 0; r < n.length; r++) {
            ...
            (e.blitFramebuffer(0, 0, a, o, 0, 0, a, o, s, e.NEAREST),
              !0 === c &&
                ((Y.length = 0),
                (q.length = 0),
                Y.push(e.COLOR_ATTACHMENT0 + r),
                t.depthBuffer &&
                  !1 === t.resolveDepthBuffer &&
                  (Y.push(l), q.push(l), e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER, q)),
                e.invalidateFramebuffer(e.READ_FRAMEBUFFER, Y)));
          }
          if (
...
function na(e, t) {
  return {
    convert: function (n, r = gt) {
      ...
      if (n === Lt) return e.UNSIGNED_INT_10F_11F_11F_REV;
      if (n === Pt) return e.BYTE;
      if (n === Ut) return e.SHORT;
      if (n === xt) return e.UNSIGNED_SHORT;
      if (n === v) return e.INT;
      if (n === Tt) return e.UNSIGNED_INT;
      if (n === T) return e.FLOAT;
      if (n === E) return e.HALF_FLOAT;
      if (n === Dt) return e.ALPHA;
      if (n === wt) return e.RGB;
      if (n === M) return e.RGBA;
      if (n === St) return e.DEPTH_COMPONENT;
      if (n === vt) return e.DEPTH_STENCIL;
      if (n === It) return e.RED;
      if (n === yt) return e.RED_INTEGER;
      if (n === Nt) return e.RG;
      if (n === Ot) return e.RG_INTEGER;
      if (n === Ft) return e.RGBA_INTEGER;
      if (n === Bt || n === Ht || n === Gt || n === Vt)
        if (a === m) {
          if (((i = t.get("WEBGL_compressed_texture_s3tc_srgb")), null === i)) return null;
          if (n === Bt) return i.COMPRESSED_SRGB_S3TC_DXT1_EXT;
          if (n === Ht) return i.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;
          if (n === Gt) return i.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;
          if (n === Vt) return i.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT;
        } else {
          if (((i = t.get("WEBGL_compressed_texture_s3tc")), null === i)) return null;
          if (n === Bt) return i.COMPRESSED_RGB_S3TC_DXT1_EXT;
          if (n === Ht) return i.COMPRESSED_RGBA_S3TC_DXT1_EXT;
          if (n === Gt) return i.COMPRESSED_RGBA_S3TC_DXT3_EXT;
          if (n === Vt) return i.COMPRESSED_RGBA_S3TC_DXT5_EXT;
        }
      if (n === zt || n === kt || n === Wt || n === Xt) {
        if (((i = t.get("WEBGL_compressed_texture_pvrtc")), null === i)) return null;
        if (n === zt) return i.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;
        if (n === kt) return i.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;
        if (n === Wt) return i.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;
        if (n === Xt) return i.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG;
      }
      if (n === Yt || n === Kt || n === qt) {
        if (((i = t.get("WEBGL_compressed_texture_etc")), null === i)) return null;
        if (n === Yt || n === Kt) return a === m ? i.COMPRESSED_SRGB8_ETC2 : i.COMPRESSED_RGB8_ETC2;
        if (n === qt)
          return a === m ? i.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC : i.COMPRESSED_RGBA8_ETC2_EAC;
      }
      if (
        n === jt ||
        n === Zt ||
        ...
        if (n === jt)
          return a === m ? i.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR : i.COMPRESSED_RGBA_ASTC_4x4_KHR;
        if (n === Zt)
          return a === m ? i.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR : i.COMPRESSED_RGBA_ASTC_5x4_KHR;
        if (n === $t)
          return a === m ? i.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR : i.COMPRESSED_RGBA_ASTC_5x5_KHR;
        if (n === Qt)
          return a === m ? i.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR : i.COMPRESSED_RGBA_ASTC_6x5_KHR;
        if (n === Jt)
          return a === m ? i.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR : i.COMPRESSED_RGBA_ASTC_6x6_KHR;
        if (n === en)
          return a === m ? i.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR : i.COMPRESSED_RGBA_ASTC_8x5_KHR;
        if (n === tn)
          return a === m ? i.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR : i.COMPRESSED_RGBA_ASTC_8x6_KHR;
        if (n === nn)
          return a === m ? i.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR : i.COMPRESSED_RGBA_ASTC_8x8_KHR;
        if (n === rn)
          return a === m
      ...
      if (n === dn || n === un || n === fn) {
        ...
        if (n === fn) return i.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT;
      }
      if (n === pn || n === mn || n === hn || n === _n) {
        if (((i = t.get("EXT_texture_compression_rgtc")), null === i)) return null;
        if (n === pn) return i.COMPRESSED_RED_RGTC1_EXT;
        if (n === mn) return i.COMPRESSED_SIGNED_RED_RGTC1_EXT;
        if (n === hn) return i.COMPRESSED_RED_GREEN_RGTC2_EXT;
        if (n === _n) return i.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT;
      }
...
class ia extends vn {
  constructor(e, n) {
    ...
    function F() {
      (a.removeEventListener("select", O),
        a.removeEventListener("selectstart", O),
        a.removeEventListener("selectend", O),
        a.removeEventListener("squeeze", O),
        a.removeEventListener("squeezestart", O),
        a.removeEventListener("squeezeend", O),
        a.removeEventListener("end", F),
        a.removeEventListener("inputsourceschange", B));
      for (let e = 0; e < R.length; e++) {
        const t = A[e];
        null !== t && ((A[e] = null), R[e].disconnect(t));
      }
      ((I = null), (N = null), g.reset());
    ...
    ((this.cameraAutoUpdate = !0),
      ...
      (this.getController = function (e) {
        let t = R[e];
        return (void 0 === t && ((t = new Sn()), (R[e] = t)), t.getTargetRaySpace());
      }),
      (this.getControllerGrip = function (e) {
        let t = R[e];
        return (void 0 === t && ((t = new Sn()), (R[e] = t)), t.getGripSpace());
      }),
      (this.getHand = function (e) {
        let t = R[e];
        return (void 0 === t && ((t = new Sn()), (R[e] = t)), t.getHandSpace());
      }),
      ...
      (this.setSession = async function (t) {
        if (((a = t), null !== a)) {
          ((T = e.getRenderTarget()),
            a.addEventListener("select", O),
            a.addEventListener("selectstart", O),
            a.addEventListener("selectend", O),
            a.addEventListener("squeeze", O),
            a.addEventListener("squeezestart", O),
            a.addEventListener("squeezeend", O),
            a.addEventListener("end", F),
            a.addEventListener("inputsourceschange", B),
          ...
          if (_ && "createProjectionLayer" in XRWebGLBinding.prototype) {
            let t = null,
              ...
              i = null;
            E.depth &&
              ((i = E.stencil ? n.DEPTH24_STENCIL8 : n.DEPTH_COMPONENT24),
              (t = E.stencil ? vt : St),
              (r = E.stencil ? Mt : Tt));
            ...
            ((f = this.getBinding()),
              ...
              (x = new y(p.textureWidth, p.textureHeight, {
                format: M,
                type: S,
                depthTexture: new q(
                  p.textureWidth,
            ...
            ((m = new XRWebGLLayer(a, n, t)),
              ...
              (x = new y(m.framebufferWidth, m.framebufferHeight, {
                format: M,
                type: S,
                colorSpace: e.outputColorSpace,
                stencilBuffer: E.stencil,
    ...
    ((this.updateCamera = function (e) {
      ...
      (null !== g.texture &&
        ...
        (w.near = P.near = L.near = t),
        (w.far = P.far = L.far = n),
        (I === w.near && N === w.far) ||
          (a.updateRenderState({ depthNear: w.near, depthFar: w.far }), (I = w.near), (N = w.far)),
        (w.layers.mask = 6 | e.layers.mask),
        (L.layers.mask = 3 & w.layers.mask),
        (P.layers.mask = 5 & w.layers.mask));
      const r = e.parent,
        i = w.cameras;
      V(w, r);
      for (let e = 0; e < i.length; e++) V(i[e], r);
      (2 === i.length
        ? (function (e, t, n) {
            (H.setFromMatrixPosition(t.matrixWorld), G.setFromMatrixPosition(n.matrixWorld));
            const r = H.distanceTo(G),
        ...
        : w.projectionMatrix.copy(L.projectionMatrix),
        (function (e, t, n) {
          null === n
          ...
          (e.matrix.decompose(e.position, e.quaternion, e.scale),
            ...
            e.isPerspectiveCamera &&
              ((e.fov = 2 * Tn * Math.atan(1 / e.projectionMatrix.elements[5])), (e.zoom = 1)));
        })(e, w, r));
    }),
    ...
    (W.setAnimationLoop(function (t, n) {
      if (((u = n.getViewerPose(d || s)), (h = n), null !== u)) {
        const t = u.views;
        null !== m && (e.setRenderTargetFramebuffer(x, m.framebuffer), e.setRenderTarget(x));
        let n = !1;
        ...
        for (let r = 0; r < t.length; r++) {
          ...
          if (null !== m) a = m.getViewport(i);
            ...
            ((a = t.viewport),
              0 === r &&
                (e.setRenderTargetTextures(x, t.colorTexture, t.depthStencilTexture),
                e.setRenderTarget(x)));
          }
          let o = D[r];
          (void 0 === o && ((o = new U()), o.layers.enable(r), (o.viewport = new k()), (D[r] = o)),
            ...
            0 === r &&
              (w.matrix.copy(o.matrix), w.matrix.decompose(w.position, w.quaternion, w.scale)),
...
class ca {
  constructor(e = {}) {
    ...
    try {
      ...
      if (
        ("setAttribute" in t && t.setAttribute("data-engine", `three.js r${Rn}`),
    ...
    function Ne() {
      ((se = new or(Ie)),
        se.init(),
        (Ue = new na(Ie, se)),
        (le = new Bn(Ie, se, e, Ue)),
        (ce = new ea(Ie, se)),
        le.reversedDepthBuffer && g && ce.buffers.depth.setReversed(!0),
        (de = new cr(Ie)),
        (ue = new Vi()),
        (pe = new ta(Ie, se, ce, ue, le, Ue, de)),
        (me = new Gn(C)),
        (he = new ar(C)),
        (_e = new Ln(Ie)),
        (De = new On(Ie, _e)),
        (ve = new sr(Ie, _e, de, De)),
        (Ee = new ur(Ie, ve, _e, de)),
        (Ce = new dr(Ie, le, pe)),
        (Re = new Hn(ue)),
        (Se = new Gi(C, me, he, se, le, De, Re)),
        (Te = new sa(C, ue)),
        (Me = new Xi()),
        (xe = new $i(se)),
        (be = new Nn(C, me, he, ce, Ee, v, d)),
        (Ae = new Qi(C, Ee, le)),
        (we = new la(Ie, de, le, ce)),
        (Le = new Fn(Ie, se, de)),
        (Pe = new lr(Ie, se, de)),
        (de.programs = Se.programs),
        (C.capabilities = le),
        (C.extensions = se),
        (C.properties = ue),
        (C.renderLists = Me),
    ...
    ((this.xr = Oe),
      ...
      (this.setViewport = function (e, t, n, r) {
        (e.isVector4 ? j.set(e.x, e.y, e.z, e.w) : j.set(e, t, n, r),
          ce.viewport(O.copy(j).multiplyScalar(Y).round()));
      }),
      ...
      (this.setScissor = function (e, t, n, r) {
        (e.isVector4 ? Z.set(e.x, e.y, e.z, e.w) : Z.set(e, t, n, r),
          ce.scissor(B.copy(Z).multiplyScalar(Y).round()));
      }),
        ...
        if (e) {
          ...
          if (e) {
            const e = w.texture.type,
              ...
              o = n.b;
            t
              ? ((T[0] = i), (T[1] = a), (T[2] = o), (T[3] = r), Ie.clearBufferuiv(Ie.COLOR, 0, T))
              : ((M[0] = i), (M[1] = a), (M[2] = o), (M[3] = r), Ie.clearBufferiv(Ie.COLOR, 0, M));
          } else r |= Ie.COLOR_BUFFER_BIT;
        }
        (t && (r |= Ie.DEPTH_BUFFER_BIT),
          n && ((r |= Ie.STENCIL_BUFFER_BIT), this.state.buffers.stencil.setMask(4294967295)),
          Ie.clear(r));
      }),
      ...
      (this.dispose = function () {
        (t.removeEventListener("webglcontextlost", Fe, !1),
          ...
          Se.dispose(),
          Oe.dispose(),
          Oe.removeEventListener("sessionstart", ke),
          Oe.removeEventListener("sessionend", We),
          Xe.stop());
      }),
      (this.renderBufferDirect = function (e, t, n, r, i, a) {
        ...
        const o = i.isMesh && i.matrixWorld.determinant() < 0,
          s = (function (e, t, n, r, i) {
              ...
              s =
                null === w
                  ...
                  : !0 === w.isXRRenderTarget
                    ...
                    : F,
              l = (r.isMeshStandardMaterial ? he : me).get(r.envMap || o),
              c =
                !0 === r.vertexColors && !!n.attributes.color && 4 === n.attributes.color.itemSize,
              d = !!n.attributes.tangent && (!!r.normalMap || r.anisotropy > 0),
              u = !!n.morphAttributes.position,
              f = !!n.morphAttributes.normal,
              p = !!n.morphAttributes.color;
            let m = D;
            r.toneMapped && ((null !== w && !0 !== w.isXRRenderTarget) || (m = C.toneMapping));
            const h =
            ...
            r.version === g.__version
              ? (g.needsLights && g.lightsStateVersion !== v.state.version) ||
                ...
                : i.isBatchedMesh || !0 !== g.batching
                  ? (i.isBatchedMesh && !0 === g.batchingColor && null === i.colorTexture) ||
                    (i.isBatchedMesh && !1 === g.batchingColor && null !== i.colorTexture) ||
                        ...
                        : i.isSkinnedMesh || !0 !== g.skinning
                          ? (i.isInstancedMesh &&
                            ...
                            : void 0 === g.numClippingPlanes ||
                                (g.numClippingPlanes === Re.numPlanes &&
                                  g.numIntersection === Re.numIntersection)
                              ? (g.vertexAlphas !== c ||
                                  g.vertexTangents !== d ||
                                  g.morphTargets !== u ||
                                  g.morphNormals !== f ||
            ...
            const A = S.getUniforms(),
              b = g.uniforms;
            ce.useProgram(S.program) && ((T = !0), (M = !0), (x = !0));
            r.id !== I && ((I = r.id), (M = !0));
            if (T || N !== e) {
              ...
              (void 0 !== t && t.setValue(Ie, ne.setFromMatrixPosition(e.matrixWorld)),
                le.logarithmicDepthBuffer &&
                  A.setValue(Ie, "logDepthBufFC", 2 / (Math.log(e.far + 1) / Math.LN2)),
            ...
            if (i.isSkinnedMesh) {
              (A.setOptional(Ie, i, "bindMatrix"), A.setOptional(Ie, i, "bindMatrixInverse"));
              const e = i.skeleton;
              e &&
                (null === e.boneTexture && e.computeBoneTexture(),
                A.setValue(Ie, "boneTexture", e.boneTexture, pe));
            }
            i.isBatchedMesh &&
              (A.setOptional(Ie, i, "batchingTexture"),
              A.setValue(Ie, "batchingTexture", i._matricesTexture, pe),
              A.setOptional(Ie, i, "batchingIdTexture"),
              A.setValue(Ie, "batchingIdTexture", i._indirectTexture, pe),
              A.setOptional(Ie, i, "batchingColorTexture"),
              null !== i._colorsTexture &&
                A.setValue(Ie, "batchingColorTexture", i._colorsTexture, pe));
            ...
            M &&
              ...
              a && !0 === r.fog && Te.refreshFogUniforms(b, a),
              Te.refreshMaterialUniforms(b, r, Y, X, R.state.transmissionRenderTarget[e.id]),
              _i.upload(Ie, Qe(g), b, pe));
            var P, U;
            r.isShaderMaterial &&
              !0 === r.uniformsNeedUpdate &&
              (_i.upload(Ie, Qe(g), b, pe), (r.uniformsNeedUpdate = !1));
        ...
        let f = d.start * c,
          p = (d.start + d.count) * c;
        (null !== a && ((f = Math.max(f, a.start * c)), (p = Math.min(p, (a.start + a.count) * c))),
          null !== l
        ...
        De.setup(i, r, s, n, l);
        let _ = Le;
        if ((null !== l && ((h = _e.get(l)), (_ = Pe), _.setIndex(h)), i.isMesh))
          !0 === r.wireframe
            ? (ce.setLineWidth(r.wireframeLinewidth * oe()), _.setMode(Ie.LINES))
            : _.setMode(Ie.TRIANGLES);
        else if (i.isLine) {
          let e = r.linewidth;
          (void 0 === e && (e = 1),
            ce.setLineWidth(e * oe()),
            i.isLineSegments
              ? _.setMode(Ie.LINES)
              : i.isLineLoop
        ...
        if (i.isBatchedMesh)
          if (null !== i._multiDrawInstances)
            ...
            _.renderMultiDraw(i._multiDrawStarts, i._multiDrawCounts, i._multiDrawCount);
          else {
            const e = i._multiDrawStarts,
              t = i._multiDrawCounts,
              n = i._multiDrawCount,
              a = l ? _e.get(l).bytesPerElement : 1,
              o = ue.get(r).currentProgram.getUniforms();
            for (let r = 0; r < n; r++) (o.setValue(Ie, "_gl_DrawID", r), _.render(e[r] / a, t[r]));
          }
        ...
        return new Promise((t) => {
          function n() {
            (r.forEach(function (e) {
              ue.get(e).currentProgram.isReady() && r.delete(e);
            }),
      ...
      if (e.layers.test(t.layers))
        if (e.isGroup) n = e.renderOrder;
          ...
          if (!e.frustumCulled || Q.intersectsSprite(e)) {
            r && re.setFromMatrixPosition(e.matrixWorld).applyMatrix4(te);
            const t = Ee.update(e),
              i = e.material;
            i.visible && x.push(e, t, i, n, re.z, null);
          }
        } else if (
          ...
          if (
            (r &&
              ...
              re.applyMatrix4(e.matrixWorld).applyMatrix4(te)),
            Array.isArray(i))
          ) {
            const r = t.groups;
            for (let a = 0, o = r.length; a < o; a++) {
              const o = r[a],
                s = i[o.materialIndex];
              s && s.visible && x.push(e, t, s, n, re.z, o);
            }
          } else i.visible && x.push(e, t, i, n, re.z, null);
        }
      const i = e.children;
    ...
    function Ke(e, t, n, r) {
      const i = e.opaque,
        ...
        o = e.transparent;
      (R.setupLightsView(n),
        !0 === J && Re.setGlobalState(C.clippingPlanes, n),
        r && ce.viewport(O.copy(r)),
        i.length > 0 && je(i, t, n),
        a.length > 0 && je(a, t, n),
        o.length > 0 && je(o, t, n),
    ...
    function qe(e, t, n, r) {
      ...
      void 0 === R.state.transmissionRenderTarget[r.id] &&
        (R.state.transmissionRenderTarget[r.id] = new y(1, 1, {
          generateMipmaps: !0,
          type: se.has("EXT_color_buffer_half_float") || se.has("EXT_color_buffer_float") ? E : S,
          minFilter: ot,
          samples: 4,
          stencilBuffer: o,
      ...
      const s = C.getRenderTarget(),
        l = C.getActiveCubeFace(),
        d = C.getActiveMipmapLevel();
      (C.setRenderTarget(i),
        C.getClearColor(V),
        (z = C.getClearAlpha()),
        ...
        C.clear(),
        ae && be.render(n));
      const u = C.toneMapping;
      C.toneMapping = D;
      const f = r.viewport;
      if (
        (void 0 !== r.viewport && (r.viewport = void 0),
        R.setupLightsView(r),
        !0 === J && Re.setGlobalState(C.clippingPlanes, r),
        je(e, n, r),
        pe.updateMultisampleRenderTarget(i),
        pe.updateRenderTargetMipmap(i),
        ...
        !0 === e && (pe.updateMultisampleRenderTarget(i), pe.updateRenderTargetMipmap(i));
      }
      (C.setRenderTarget(s, l, d),
        C.setClearColor(V, z),
        void 0 !== f && (r.viewport = f),
        (C.toneMapping = u));
    }
    function je(e, t, n) {
      ...
      for (let i = 0, a = e.length; i < a; i++) {
        ...
        (!0 === c.allowOverride && null !== r && (c = r),
          o.layers.test(n.layers) && Ze(o, t, n, s, c, l));
      }
    }
    ...
    function $e(e, t, n) {
      ...
      const r = ue.get(e),
        ...
        l = Se.getProgramCacheKey(s);
      let c = r.programs;
      ((r.environment = e.isMeshStandardMaterial ? t.environment : null),
        (r.fog = t.fog),
        (r.envMap = (e.isMeshStandardMaterial ? he : me).get(e.envMap || r.environment)),
        (r.envMapRotation =
          null !== r.environment && null === e.envMap ? t.environmentRotation : e.envMapRotation),
        void 0 === c && (e.addEventListener("dispose", Ge), (c = new Map()), (r.programs = c)));
      let d = c.get(l);
      if (void 0 !== d) {
        if (r.currentProgram === d && r.lightsStateVersion === o) return (Je(e, s), d);
      } else
        ((s.uniforms = Se.getUniforms(e)),
          e.onBeforeCompile(s, C),
          (d = Se.acquireProgram(s, l)),
          c.set(l, d),
          (r.uniforms = s.uniforms));
      const u = r.uniforms;
      return (
        ((e.isShaderMaterial || e.isRawShaderMaterial) && !0 !== e.clipping) ||
          (u.clippingPlanes = Re.uniform),
        Je(e, s),
    ...
    (Xe.setAnimationLoop(function (e) {
      ...
      (this.setAnimationLoop = function (e) {
        ((ze = e), Oe.setAnimationLoop(e), null === e ? Xe.stop() : Xe.start());
      }),
      Oe.addEventListener("sessionstart", ke),
      Oe.addEventListener("sessionend", We),
      (this.render = function (e, t) {
        ...
        if (
          ...
          !0 === Oe.enabled &&
            !0 === Oe.isPresenting &&
            (!0 === Oe.cameraAutoUpdate && Oe.updateCamera(t), (t = Oe.getCamera())),
          !0 === e.isScene && e.onBeforeRender(C, e, t, w),
          (R = xe.get(e, b.length)),
          R.init(t),
          b.push(R),
          te.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse),
          Q.setFromProjectionMatrix(te, An, t.reversedDepth),
          (ee = this.localClippingEnabled),
          (J = Re.init(this.clippingPlanes, ee)),
          (x = Me.get(e, A.length)),
          x.init(),
          A.push(x),
          ...
          null !== e && Ye(e, t, -1 / 0, C.sortObjects);
        }
        (Ye(e, t, 0, C.sortObjects),
          x.finish(),
          !0 === C.sortObjects && x.sort(K, q),
          (ae = !1 === Oe.enabled || !1 === Oe.isPresenting || !1 === Oe.hasDepthSensing()),
          ae && be.addToRenderList(x, e),
        ...
        } else (i.length > 0 && qe(r, i, e, t), ae && be.render(e), Ke(x, e, t));
        (null !== w &&
          0 === U &&
          ...
          b.length > 0
            ? ((R = b[b.length - 1]),
              !0 === J && Re.setGlobalState(C.clippingPlanes, R.state.camera))
            : (R = null),
          A.pop(),
      ...
      (this.setRenderTargetTextures = function (e, t, n) {
        ...
        ((r.__autoAllocateDepthBuffer = !1 === e.resolveDepthBuffer),
          ...
          (ue.get(e.texture).__webglTexture = t),
          (ue.get(e.depthTexture).__webglTexture = r.__autoAllocateDepthBuffer ? void 0 : n),
    ...
    ((this.setRenderTarget = function (e, t = 0, n = 0) {
      ...
      if (e) {
        ...
        if (void 0 !== s.__useDefaultFramebuffer)
          (ce.bindFramebuffer(Ie.FRAMEBUFFER, null), (r = !1));
        else if (void 0 === s.__webglFramebuffer) pe.setupRenderTarget(e);
        ...
        (e.isWebGLCubeRenderTarget
          ...
          : (i =
              e.samples > 0 && !1 === pe.useMultisampledRTT(e)
                ? ue.get(e).__webglMultisampledFramebuffer
                : Array.isArray(c)
                  ? c[n]
                  : c),
          O.copy(e.viewport),
          B.copy(e.scissor),
          (G = e.scissorTest));
      } else (O.copy(j).multiplyScalar(Y).floor(), B.copy(Z).multiplyScalar(Y).floor(), (G = $));
      0 !== n && (i = et);
      if (
        (ce.bindFramebuffer(Ie.FRAMEBUFFER, i) && r && ce.drawBuffers(e, i),
        ce.viewport(O),
        ce.scissor(B),
        ce.setScissorTest(G),
        a)
      ) {
        const r = ue.get(e.texture);
        ...
        for (let t = 0; t < e.textures.length; t++) {
          const i = ue.get(e.textures[t]);
          Ie.framebufferTextureLayer(
            Ie.FRAMEBUFFER,
            Ie.COLOR_ATTACHMENT0 + t,
            i.__webglTexture,
            n,
            r,
          );
      ...
      (this.readRenderTargetPixels = function (e, t, n, r, i, a, o, s = 0) {
        ...
        let l = ue.get(e).__webglFramebuffer;
        if ((e.isWebGLCubeRenderTarget && void 0 !== o && (l = l[o]), l)) {
          ce.bindFramebuffer(Ie.FRAMEBUFFER, l);
          try {
            const o = e.textures[s],
              l = o.format,
              c = o.type;
            if (!le.textureFormatReadable(l))
              return void console.error(
                "THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.",
              );
            if (!le.textureTypeReadable(c))
              return void console.error(
            ...
            t >= 0 &&
              ...
              n >= 0 &&
              n <= e.height - i &&
              (e.textures.length > 1 && Ie.readBuffer(Ie.COLOR_ATTACHMENT0 + s),
              Ie.readPixels(t, n, r, i, Ue.convert(l), Ue.convert(c), a));
          } finally {
            const e = null !== w ? ue.get(w).__webglFramebuffer : null;
            ce.bindFramebuffer(Ie.FRAMEBUFFER, e);
          }
        }
      }),
        ...
        if ((e.isWebGLCubeRenderTarget && void 0 !== o && (l = l[o]), l)) {
          if (t >= 0 && t <= e.width - r && n >= 0 && n <= e.height - i) {
            ...
            const o = e.textures[s],
              c = o.format,
              d = o.type;
            if (!le.textureFormatReadable(c))
              throw new Error(
                "THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.",
              );
            if (!le.textureTypeReadable(d))
              throw new Error(
                "THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.",
              );
            const u = Ie.createBuffer();
            (Ie.bindBuffer(Ie.PIXEL_PACK_BUFFER, u),
              Ie.bufferData(Ie.PIXEL_PACK_BUFFER, a.byteLength, Ie.STREAM_READ),
              e.textures.length > 1 && Ie.readBuffer(Ie.COLOR_ATTACHMENT0 + s),
              Ie.readPixels(t, n, r, i, Ue.convert(c), Ue.convert(d), 0));
            const f = null !== w ? ue.get(w).__webglFramebuffer : null;
            ce.bindFramebuffer(Ie.FRAMEBUFFER, f);
            const p = Ie.fenceSync(Ie.SYNC_GPU_COMMANDS_COMPLETE, 0);
            return (
              Ie.flush(),
              await bn(Ie, p, 4),
              Ie.bindBuffer(Ie.PIXEL_PACK_BUFFER, u),
    ...
    ((this.copyTextureToTexture = function (e, t, n = null, r = null, i = 0, a = null) {
      ...
      const _ = Ue.convert(t.format),
        g = Ue.convert(t.type);
      let v;
      (t.isData3DTexture
        ? (pe.setTexture3D(t, 0), (v = Ie.TEXTURE_3D))
        : t.isDataArrayTexture || t.isCompressedArrayTexture
          ? (pe.setTexture2DArray(t, 0), (v = Ie.TEXTURE_2D_ARRAY))
          : (pe.setTexture2D(t, 0), (v = Ie.TEXTURE_2D)),
      ...
      if (e.isDepthTexture) {
        const n = ue.get(e),
          r = ue.get(t),
          h = ue.get(n.__renderTarget),
          _ = ue.get(r.__renderTarget);
        (ce.bindFramebuffer(Ie.READ_FRAMEBUFFER, h.__webglFramebuffer),
          ce.bindFramebuffer(Ie.DRAW_FRAMEBUFFER, _.__webglFramebuffer));
        for (let n = 0; n < l; n++)
          (R &&
            (Ie.framebufferTextureLayer(
              Ie.READ_FRAMEBUFFER,
              Ie.COLOR_ATTACHMENT0,
              ue.get(e).__webglTexture,
              i,
              u + n,
            ),
            Ie.framebufferTextureLayer(
        ...
        (ce.bindFramebuffer(Ie.READ_FRAMEBUFFER, null),
          ce.bindFramebuffer(Ie.DRAW_FRAMEBUFFER, null));
      } else if (0 !== i || e.isRenderTargetTexture || ue.has(e)) {
        const n = ue.get(e),
          r = ue.get(t);
        (ce.bindFramebuffer(Ie.READ_FRAMEBUFFER, tt), ce.bindFramebuffer(Ie.DRAW_FRAMEBUFFER, nt));
        for (let e = 0; e < l; e++)
          (R
            ? Ie.framebufferTextureLayer(
                Ie.READ_FRAMEBUFFER,
            ...
            0 !== i
              ? Ie.blitFramebuffer(c, d, o, s, f, p, o, s, Ie.COLOR_BUFFER_BIT, Ie.NEAREST)
              : A
        ...
        A
          ...
          : e.isDataTexture
            ...
            : e.isCompressedTexture
              ? Ie.compressedTexSubImage2D(Ie.TEXTURE_2D, a, f, p, h.width, h.height, _, h.data)
      ...
      (this.initRenderTarget = function (e) {
        void 0 === ue.get(e).__webglFramebuffer && pe.setupRenderTarget(e);
      }),
      ...
      (this.resetState = function () {
        ((P = 0), (U = 0), (w = null), ce.reset(), De.reset());
      }),
...
export {
  ...
  x as Plane,
  h as PlaneGeometry,
  hn as RED_GREEN_RGTC2_Format,
  pn as RED_RGTC1_Format,
  Rn as REVISION,
  Ee as RGBADepthPacking,
  M as RGBAFormat,
  Ft as RGBAIntegerFormat,
  sn as RGBA_ASTC_10x10_Format,
  rn as RGBA_ASTC_10x5_Format,
  an as RGBA_ASTC_10x6_Format,
  on as RGBA_ASTC_10x8_Format,
  ln as RGBA_ASTC_12x10_Format,
  cn as RGBA_ASTC_12x12_Format,
  jt as RGBA_ASTC_4x4_Format,
  Zt as RGBA_ASTC_5x4_Format,
  $t as RGBA_ASTC_5x5_Format,
  Qt as RGBA_ASTC_6x5_Format,
  Jt as RGBA_ASTC_6x6_Format,
  en as RGBA_ASTC_8x5_Format,
  tn as RGBA_ASTC_8x6_Format,
  nn as RGBA_ASTC_8x8_Format,
  dn as RGBA_BPTC_Format,
  qt as RGBA_ETC2_EAC_Format,
  Xt as RGBA_PVRTC_2BPPV1_Format,
  Wt as RGBA_PVRTC_4BPPV1_Format,
  Ht as RGBA_S3TC_DXT1_Format,
  Gt as RGBA_S3TC_DXT3_Format,
  Vt as RGBA_S3TC_DXT5_Format,
  wt as RGBFormat,
  un as RGB_BPTC_SIGNED_Format,
  fn as RGB_BPTC_UNSIGNED_Format,
  Yt as RGB_ETC1_Format,
  Kt as RGB_ETC2_Format,
  kt as RGB_PVRTC_2BPPV1_Format,
  zt as RGB_PVRTC_4BPPV1_Format,
  Bt as RGB_S3TC_DXT1_Format,
  Nt as RGFormat,
  Ot as RGIntegerFormat,
  It as RedFormat,
  yt as RedIntegerFormat,
  ae as ReinhardToneMapping,
  at as RepeatWrapping,
  xe as ReverseSubtractEquation,
  _n as SIGNED_RED_GREEN_RGTC2_Format,
  mn as SIGNED_RED_RGTC1_Format,
  xn as SRGBColorSpace,
  m as SRGBTransfer,
  Pn as ShaderChunk,
  Dn as ShaderLib,
  l as ShaderMaterial,
  ...
  i as Vector3,
  k as Vector4,
  An as WebGLCoordinateSystem,
  b as WebGLCubeRenderTarget,
  y as WebGLRenderTarget,
  ca as WebGLRenderer,
  na as WebGLUtils,
  Sn as WebXRController,
  Ge as ZeroFactor,
  Mn as createCanvasElement,
};
