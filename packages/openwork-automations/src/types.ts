...
export const automationRunTriggerSchema = z.enum(["scheduled", "recovery", "manual", "webhook"]);
...
export type AutomationDesktopRunnerRegistration = z.infer<
  typeof automationDesktopRunnerRegistrationSchema
>;

export const automationRunnerNotificationSchema = z
  .object({
...
export type AutomationDesktopRunnerAssignment = z.infer<
  typeof automationDesktopRunnerAssignmentSchema
>;
...
export const automationRunnerHeartbeatRequestSchema = z.object({
  attempt: z.number().int().positive(),
});
