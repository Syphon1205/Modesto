import { EnvironmentId, type ExecutionEnvironmentDescriptor } from "@modesto/contracts";
import type { RelayManagedEndpoint } from "@modesto/contracts/relay";
import {
...
>()("@modesto/client-runtime/authorization/service/RemoteEnvironmentAuthorization") {}
