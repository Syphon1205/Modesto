import { EnvironmentId } from "@modesto/contracts";
import { RelayManagedEndpoint } from "@modesto/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@modesto/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@modesto/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
