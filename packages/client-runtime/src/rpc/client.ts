import { DEVICE_WS_METHODS, ORCHESTRATION_WS_METHODS, WS_METHODS } from "@modesto/contracts";
...
}>("@modesto/client-runtime/rpc/EnvironmentRpcRequestObserver", {
  defaultValue: () => ({
...
export type EnvironmentSubscriptionRpcTag =
  ...
  | typeof DEVICE_WS_METHODS.subscribeEvents
...
}>("@modesto/client-runtime/rpc/EnvironmentRpcSubscriptionObserver", {
  defaultValue: () => ({
    observe: () => Effect.succeed(Effect.void),
  }),
}) {}
