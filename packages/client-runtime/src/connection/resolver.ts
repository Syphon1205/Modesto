import type { AuthClientPresentationMetadata } from "@modesto/contracts";
import { RelayEnvironmentConnectScope } from "@modesto/contracts/relay";
...
>()("@modesto/client-runtime/connection/resolver/ConnectionResolver") {}
