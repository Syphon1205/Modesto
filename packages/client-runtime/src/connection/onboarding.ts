import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@modesto/contracts";
import { resolveRemotePairingTarget } from "@modesto/shared/remote";
...
>()("@modesto/client-runtime/connection/onboarding/ConnectionOnboarding") {}
