...
export const WS_METHODS = {
  ...
  // Repo memory methods
  repoMemoryList: "repoMemory.list",
  repoMemorySuggest: "repoMemory.suggest",
  repoMemoryApplyWrite: "repoMemory.applyWrite",
  ...
  serverSetMcpServerEnabled: "server.setMcpServerEnabled",
  serverUpsertMcpServer: "server.upsertMcpServer",
  serverRemoveMcpServer: "server.removeMcpServer",
  serverListHooks: "server.listHooks",
  serverSetHook: "server.setHook",
  serverListAgentRules: "server.listAgentRules",
  serverRefreshProviders: "server.refreshProviders",
  serverUpdateProvider: "server.updateProvider",
  serverSetProviderApiKey: "server.setProviderApiKey",
  serverClearProviderApiKey: "server.clearProviderApiKey",
  serverProviderSignIn: "server.providerSignIn",
  ...
  statsGetProfileCommitActivity: "stats.getProfileCommitActivity",
  ...
  providerSetPluginInstalled: "provider.setPluginInstalled",
  ...
  openClawUpdateConfig: "openclaw.updateConfig",
  openClawSetup: "openclaw.setup",
  openClawTestConnection: "openclaw.testConnection",
  subscribeOpenClawEvents: "openclaw.subscribe",
  ...
  reviewIgnoreFinding: "review.ignoreFinding",
  subscribeReviewEvents: "review.subscribe",
} as const;
...
const WebSocketRequestBody = Schema.Union([
  ...
  tagRequestBody(ORCHESTRATION_WS_METHODS.compareCheckpoints, OrchestrationCompareCheckpointsInput),
  tagRequestBody(
  ...
  // Repo memory
  tagRequestBody(WS_METHODS.repoMemoryList, RepoMemoryListInput),
  tagRequestBody(WS_METHODS.repoMemorySuggest, RepoMemorySuggestInput),
  tagRequestBody(WS_METHODS.repoMemoryApplyWrite, RepoMemoryApplyWriteInput),
  ...
  tagRequestBody(WS_METHODS.gitGithubAuthStatus, GitHubAuthStatusInput),
  tagRequestBody(WS_METHODS.gitGithubSignIn, GitHubSignInInput),
  tagRequestBody(WS_METHODS.gitGithubSignOut, GitHubSignOutInput),
  ...
  tagRequestBody(WS_METHODS.serverListMcpServers, Schema.Struct({})),
  tagRequestBody(WS_METHODS.serverSetMcpServerEnabled, McpServerEnabledInput),
  tagRequestBody(WS_METHODS.serverUpsertMcpServer, McpServerUpsertInput),
  tagRequestBody(WS_METHODS.serverRemoveMcpServer, McpServerRemoveInput),
  tagRequestBody(WS_METHODS.serverListHooks, Schema.Struct({})),
  tagRequestBody(WS_METHODS.serverSetHook, HookSetInput),
  tagRequestBody(WS_METHODS.serverListAgentRules, Schema.Struct({})),
  ...
  tagRequestBody(WS_METHODS.serverSetProviderApiKey, ServerSetProviderApiKeyInput),
  tagRequestBody(WS_METHODS.serverClearProviderApiKey, ServerClearProviderApiKeyInput),
  tagRequestBody(WS_METHODS.serverProviderSignIn, ServerProviderSignInInput),
  tagRequestBody(WS_METHODS.serverSetCustomModelEndpoint, ServerSetCustomModelEndpointInput),
  tagRequestBody(WS_METHODS.serverDeleteCustomModelEndpoint, ServerDeleteCustomModelEndpointInput),
  ...
  tagRequestBody(WS_METHODS.statsGetProfileCommitActivity, StatsGetProfileCommitActivityInput),
  ...
  tagRequestBody(WS_METHODS.providerSetPluginInstalled, ProviderSetPluginInstalledInput),
  ...
  tagRequestBody(WS_METHODS.openClawTestConnection, OpenClawTestConnectionInput),
  tagRequestBody(WS_METHODS.subscribeOpenClawEvents, Schema.Struct({})),
  tagRequestBody(WS_METHODS.reviewProviders, Schema.Struct({})),
  tagRequestBody(WS_METHODS.reviewInstall, ReviewInstallInput),
  tagRequestBody(WS_METHODS.reviewList, ReviewListInput),
  tagRequestBody(WS_METHODS.reviewStart, ReviewStartInput),
  tagRequestBody(WS_METHODS.reviewCancel, ReviewCancelInput),
  tagRequestBody(WS_METHODS.reviewIgnoreFinding, ReviewIgnoreFindingInput),
  tagRequestBody(WS_METHODS.subscribeReviewEvents, Schema.Struct({})),
]);
...
export interface WsPushPayloadByChannel {
  ...
  readonly [WS_CHANNELS.openClawEvent]: typeof OpenClawStreamEvent.Type;
  readonly [WS_CHANNELS.reviewEvent]: typeof ReviewStreamEvent.Type;
...
export const WsPushOpenClawEvent = makeWsPushSchema(WS_CHANNELS.openClawEvent, OpenClawStreamEvent);
export const WsPushReviewEvent = makeWsPushSchema(WS_CHANNELS.reviewEvent, ReviewStreamEvent);
...
export const WsPushChannelSchema = Schema.Literals([
  ...
  WS_CHANNELS.serverSettingsUpdated,
  WS_CHANNELS.automationEvent,
  WS_CHANNELS.openClawEvent,
  WS_CHANNELS.reviewEvent,
