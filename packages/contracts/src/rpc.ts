...
import {
  RepoMemoryApplyWriteInput,
  RepoMemoryApplyWriteResult,
  RepoMemoryListInput,
  RepoMemoryListResult,
  RepoMemorySuggestInput,
  RepoMemorySuggestResult,
} from "./repoMemory";
...
import {
  ...
  OpenClawGetSnapshotInput,
  OpenClawSetupInput,
  OpenClawSnapshot,
  OpenClawStreamEvent,
  OpenClawTestConnectionInput,
} from "./openclaw";
import {
  ReviewCancelInput,
  ReviewFinding,
...
import {
  ...
  ProviderSetPluginInstalledInput,
  ProviderSetPluginInstalledResult,
...
import {
  ...
  ServerSetProviderApiKeyResult,
  ServerClearProviderApiKeyInput,
  ServerClearProviderApiKeyResult,
...
import {
  ...
  StatsGetProfileCommitActivityInput,
  StatsGetProfileCommitActivityResult,
...
export const WsOrchestrationCaptureHandoffCheckpointRpc = Rpc.make(
  ORCHESTRATION_WS_METHODS.captureHandoffCheckpoint,
  {
    payload: OrchestrationRpcSchemas.captureHandoffCheckpoint.input,
    success: OrchestrationRpcSchemas.captureHandoffCheckpoint.output,
    error: WsRpcError,
  },
);
...
export const WsOrchestrationGetHandoffCheckpointDiffRpc = Rpc.make(
  ...
  {
    payload: OrchestrationRpcSchemas.getHandoffCheckpointDiff.input,
    success: OrchestrationRpcSchemas.getHandoffCheckpointDiff.output,
    error: WsRpcError,
  },
);

export const WsOrchestrationRestoreHandoffCheckpointRpc = Rpc.make(
  ORCHESTRATION_WS_METHODS.restoreHandoffCheckpoint,
  {
    payload: OrchestrationRpcSchemas.restoreHandoffCheckpoint.input,
    success: OrchestrationRpcSchemas.restoreHandoffCheckpoint.output,
    error: WsRpcError,
  },
);
...
export const WsRepoMemoryListRpc = Rpc.make(WS_METHODS.repoMemoryList, {
  payload: RepoMemoryListInput,
  success: RepoMemoryListResult,
  error: WsRpcError,
});

export const WsRepoMemorySuggestRpc = Rpc.make(WS_METHODS.repoMemorySuggest, {
  payload: RepoMemorySuggestInput,
  success: RepoMemorySuggestResult,
  error: WsRpcError,
});

export const WsRepoMemoryApplyWriteRpc = Rpc.make(WS_METHODS.repoMemoryApplyWrite, {
  payload: RepoMemoryApplyWriteInput,
  success: RepoMemoryApplyWriteResult,
  error: WsRpcError,
});
...
export const WsServerListMcpServersRpc = Rpc.make(WS_METHODS.serverListMcpServers, {
  payload: Schema.Struct({}), success: McpServersResult, error: WsRpcError,
});
export const WsServerSetMcpServerEnabledRpc = Rpc.make(WS_METHODS.serverSetMcpServerEnabled, {
  payload: McpServerEnabledInput, success: McpServersResult, error: WsRpcError,
});
export const WsServerUpsertMcpServerRpc = Rpc.make(WS_METHODS.serverUpsertMcpServer, {
  payload: McpServerUpsertInput, success: McpServersResult, error: WsRpcError,
});
export const WsServerRemoveMcpServerRpc = Rpc.make(WS_METHODS.serverRemoveMcpServer, {
  payload: McpServerRemoveInput, success: McpServersResult, error: WsRpcError,
});
export const WsServerListHooksRpc = Rpc.make(WS_METHODS.serverListHooks, {
  payload: Schema.Struct({}), success: HooksResult, error: WsRpcError,
});
export const WsServerSetHookRpc = Rpc.make(WS_METHODS.serverSetHook, {
  payload: HookSetInput, success: HooksResult, error: WsRpcError,
});
export const WsServerListAgentRulesRpc = Rpc.make(WS_METHODS.serverListAgentRules, {
  payload: Schema.Struct({}), success: AgentRulesResult, error: WsRpcError,
});
...
export const WsServerSetProviderApiKeyRpc = Rpc.make(WS_METHODS.serverSetProviderApiKey, {
  payload: ServerSetProviderApiKeyInput,
  success: ServerSetProviderApiKeyResult,
  error: ServerProviderCredentialError,
});

export const WsServerClearProviderApiKeyRpc = Rpc.make(WS_METHODS.serverClearProviderApiKey, {
  payload: ServerClearProviderApiKeyInput,
  success: ServerClearProviderApiKeyResult,
  error: ServerProviderCredentialError,
});

export const WsServerProviderSignInRpc = Rpc.make(WS_METHODS.serverProviderSignIn, {
  payload: ServerProviderSignInInput,
  success: ServerProviderSignInResult,
  error: ServerProviderCredentialError,
});
...
export const WsServerSetCustomModelEndpointRpc = Rpc.make(WS_METHODS.serverSetCustomModelEndpoint, {
  ...
  error: ServerCustomModelEndpointError,
});
...
export const WsStatsGetProfileCommitActivityRpc = Rpc.make(
  WS_METHODS.statsGetProfileCommitActivity,
  {
    payload: StatsGetProfileCommitActivityInput,
    success: StatsGetProfileCommitActivityResult,
    error: WsRpcError,
  },
);
...
export const WsProviderSetPluginInstalledRpc = Rpc.make(WS_METHODS.providerSetPluginInstalled, {
  payload: ProviderSetPluginInstalledInput,
  success: ProviderSetPluginInstalledResult,
  error: WsRpcError,
});
...
export const WsOpenClawUpdateConfigRpc = Rpc.make(WS_METHODS.openClawUpdateConfig, {
  payload: OpenClawConnectionConfigUpdate,
  success: OpenClawSnapshot,
  error: WsRpcError,
});

export const WsOpenClawSetupRpc = Rpc.make(WS_METHODS.openClawSetup, {
  payload: OpenClawSetupInput,
  success: OpenClawGatewayStatus,
  error: WsRpcError,
});

export const WsOpenClawTestConnectionRpc = Rpc.make(WS_METHODS.openClawTestConnection, {
  payload: OpenClawTestConnectionInput,
  success: OpenClawGatewayStatus,
  error: WsRpcError,
});

export const WsSubscribeOpenClawEventsRpc = Rpc.make(WS_METHODS.subscribeOpenClawEvents, {
  payload: Schema.Struct({}),
  success: OpenClawStreamEvent,
  error: WsRpcError,
  stream: true,
});

export const WsReviewListRpc = Rpc.make(WS_METHODS.reviewList, {
  payload: ReviewListInput,
  success: ReviewListResult,
  error: WsRpcError,
});

export const WsReviewProvidersRpc = Rpc.make(WS_METHODS.reviewProviders, {
  payload: Schema.Struct({}),
  success: ReviewProviderListResult,
  error: WsRpcError,
});

export const WsReviewInstallRpc = Rpc.make(WS_METHODS.reviewInstall, {
  payload: ReviewInstallInput,
  success: ReviewInstallResult,
  error: WsRpcError,
});

export const WsReviewStartRpc = Rpc.make(WS_METHODS.reviewStart, {
  payload: ReviewStartInput,
  success: ReviewRun,
  error: WsRpcError,
});

export const WsReviewCancelRpc = Rpc.make(WS_METHODS.reviewCancel, {
  payload: ReviewCancelInput,
  success: ReviewRun,
  error: WsRpcError,
});

export const WsReviewIgnoreFindingRpc = Rpc.make(WS_METHODS.reviewIgnoreFinding, {
  payload: ReviewIgnoreFindingInput,
  success: ReviewFinding,
  error: WsRpcError,
});
...
export const WsRpcGroup = RpcGroup.make(
  ...
  WsRepoMemoryListRpc,
  WsRepoMemorySuggestRpc,
  WsRepoMemoryApplyWriteRpc,
  ...
  WsServerSetMcpServerEnabledRpc,
  WsServerUpsertMcpServerRpc,
  WsServerRemoveMcpServerRpc,
  WsServerListHooksRpc,
  WsServerSetHookRpc,
  WsServerListAgentRulesRpc,
  WsServerRefreshProvidersRpc,
  WsServerUpdateProviderRpc,
  WsServerSetProviderApiKeyRpc,
  WsServerClearProviderApiKeyRpc,
  WsServerProviderSignInRpc,
  ...
  WsStatsGetProfileCommitActivityRpc,
  ...
  WsProviderSetPluginInstalledRpc,
  ...
  WsOpenClawSetupRpc,
  WsOpenClawTestConnectionRpc,
  WsSubscribeOpenClawEventsRpc,
  WsReviewListRpc,
  WsReviewProvidersRpc,
  WsReviewInstallRpc,
  WsReviewStartRpc,
  WsReviewCancelRpc,
  WsReviewIgnoreFindingRpc,
