...
export const GitHubAuthStatusInput = Schema.Struct({});
export type GitHubAuthStatusInput = typeof GitHubAuthStatusInput.Type;

export const GitHubSignInInput = Schema.Struct({});
export type GitHubSignInInput = typeof GitHubSignInInput.Type;

export const GitHubSignOutInput = Schema.Struct({});
export type GitHubSignOutInput = typeof GitHubSignOutInput.Type;
...
export const GitHubAuthStatusResult = Schema.Struct({
  installed: Schema.Boolean,
  authenticated: Schema.Boolean,
  login: Schema.NullOr(TrimmedNonEmptyStringSchema),
  name: Schema.NullOr(TrimmedNonEmptyStringSchema),
  avatarUrl: Schema.NullOr(TrimmedNonEmptyStringSchema),
});
export type GitHubAuthStatusResult = typeof GitHubAuthStatusResult.Type;

export const GitHubSignInResult = Schema.Struct({
  started: Schema.Boolean,
  userCode: Schema.NullOr(TrimmedNonEmptyStringSchema),
});
export type GitHubSignInResult = typeof GitHubSignInResult.Type;

export const GitHubSignOutResult = Schema.Struct({
  signedOut: Schema.Boolean,
});
export type GitHubSignOutResult = typeof GitHubSignOutResult.Type;
