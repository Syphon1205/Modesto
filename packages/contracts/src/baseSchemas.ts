...
export const IncomingTaskId = makeEntityId("IncomingTaskId");
export type IncomingTaskId = typeof IncomingTaskId.Type;
export const ReviewRunId = makeEntityId("ReviewRunId");
export type ReviewRunId = typeof ReviewRunId.Type;
export const ReviewFindingId = makeEntityId("ReviewFindingId");
