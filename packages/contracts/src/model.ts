...
const META_DRIVER_KIND = ProviderDriverKind.make("meta");
...
export const DEFAULT_MODEL_BY_PROVIDER: Partial<Record<ProviderDriverKind, string>> = {
  ...
  [META_DRIVER_KIND]: "muse-spark-1.3",
  [KILO_DRIVER_KIND]: "kilo/kilo-auto/free",
  [GITHUB_COPILOT_DRIVER_KIND]: "auto",
  // Pi has no fixed default model — its catalog is entirely runtime-discovered
  // via the adapter's listModels, so it is intentionally omitted here.
};
