...
export const CodexProviderStartOptions = Schema.Struct({
  ...
  // Routes this session's codex app-server process at a Settings → Model Routers
  // custom endpoint (`-c model_provider=<id>`) instead of the default provider.
  customEndpointId: Schema.optional(TrimmedNonEmptyString),
});
...
export const ThreadHandoffDiffAckStatus = Schema.Literals([
  "not_required",
  "pending",
  "acknowledged",
]);
export type ThreadHandoffDiffAckStatus = typeof ThreadHandoffDiffAckStatus.Type;
export const ThreadHandoffCheckpointStatus = Schema.Literals([
  "not_applicable",
  "captured",
  "missing",
  "rolled_back",
]);
export type ThreadHandoffCheckpointStatus = typeof ThreadHandoffCheckpointStatus.Type;
export const ThreadHandoffStepStatus = Schema.Literals(["todo", "doing", "done", "blocked"]);
export type ThreadHandoffStepStatus = typeof ThreadHandoffStepStatus.Type;
...
/** Where a piece of injected or displayed context originated. */
...
/** Freshness of a context artifact relative to the live workspace / conversation. */
export const ContextFreshness = Schema.Literals(["current", "stale", "superseded", "user-edited"]);
export type ContextFreshness = typeof ContextFreshness.Type;

export const ContextProvenance = Schema.Struct({
  sourceKind: ContextSourceKind,
  freshness: ContextFreshness,
  path: Schema.optional(Schema.NullOr(TrimmedNonEmptyString)).pipe(
    Schema.withDecodingDefault(() => null),
  ),
  label: Schema.optional(Schema.NullOr(TrimmedNonEmptyString)).pipe(
    Schema.withDecodingDefault(() => null),
  ),
  contentHash: Schema.optional(Schema.NullOr(TrimmedNonEmptyString)).pipe(
    Schema.withDecodingDefault(() => null),
  ),
  capturedAt: Schema.optional(Schema.NullOr(IsoDateTime)).pipe(
    Schema.withDecodingDefault(() => null),
  ),
  threadId: Schema.optional(Schema.NullOr(ThreadId)).pipe(Schema.withDecodingDefault(() => null)),
  metadata: Schema.optional(Schema.NullOr(Schema.Json)).pipe(
    Schema.withDecodingDefault(() => null),
  ),
});
...
export const OrchestrationMessage = Schema.Struct({
  ...
  provenance: Schema.optional(Schema.NullOr(ContextProvenance)).pipe(
    Schema.withDecodingDefault(() => null),
  ),
  createdAt: IsoDateTime,
  updatedAt: IsoDateTime,
...
export const ThreadHandoffStep = Schema.Struct({
  id: TrimmedNonEmptyString,
  text: TrimmedNonEmptyString,
  status: ThreadHandoffStepStatus,
});
export type ThreadHandoffStep = typeof ThreadHandoffStep.Type;

export const ThreadHandoffChangedFile = Schema.Struct({
  path: TrimmedNonEmptyString,
  insertions: NonNegativeInt,
  deletions: NonNegativeInt,
});
export type ThreadHandoffChangedFile = typeof ThreadHandoffChangedFile.Type;

export const ThreadHandoffRepoSnapshot = Schema.Struct({
  headSha: Schema.NullOr(TrimmedNonEmptyString),
  branch: Schema.NullOr(TrimmedNonEmptyString),
  worktreePath: Schema.NullOr(TrimmedNonEmptyString),
  hasWorkingTreeChanges: Schema.Boolean,
  changedFiles: Schema.Array(ThreadHandoffChangedFile),
  statusSummary: Schema.NullOr(Schema.String),
  diffSummaryMarkdown: Schema.NullOr(Schema.String),
  capturedAt: IsoDateTime,
});
export type ThreadHandoffRepoSnapshot = typeof ThreadHandoffRepoSnapshot.Type;

export const ThreadHandoffReturnPayload = Schema.Struct({
  ...
  completedStepIds: Schema.optional(Schema.Array(TrimmedNonEmptyString)).pipe(
    Schema.withDecodingDefault(() => []),
  ),
  returnedAt: IsoDateTime,
});
export type ThreadHandoffReturnPayload = typeof ThreadHandoffReturnPayload.Type;
...
export const ThreadHandoff = Schema.Struct({
  ...
  summary: Schema.optional(Schema.NullOr(Schema.String)).pipe(
    Schema.withDecodingDefault(() => null),
  ),
  objective: Schema.optional(Schema.NullOr(Schema.String)).pipe(
    Schema.withDecodingDefault(() => null),
  ),
  ...
  diffAckStatus: Schema.optional(ThreadHandoffDiffAckStatus).pipe(
    Schema.withDecodingDefault(() => "not_required"),
  ),
  // Durable orphan-commit seam captured at handoff time (hidden git refs).
  checkpointRef: Schema.optional(Schema.NullOr(CheckpointRef)).pipe(
    Schema.withDecodingDefault(() => null),
  ),
  baseCheckpointRef: Schema.optional(Schema.NullOr(CheckpointRef)).pipe(
    Schema.withDecodingDefault(() => null),
  ),
  baseHeadSha: Schema.optional(Schema.NullOr(TrimmedNonEmptyString)).pipe(
    Schema.withDecodingDefault(() => null),
  ),
  checkpointStatus: Schema.optional(ThreadHandoffCheckpointStatus).pipe(
    Schema.withDecodingDefault(() => "not_applicable"),
  ),
});
...
export const OrchestrationThread = Schema.Struct({
  ...
  handoffReturn: Schema.optional(Schema.NullOr(ThreadHandoffReturnPayload)).pipe(
    Schema.withDecodingDefault(() => null),
  ),
...
const ThreadHandoffCreateCommand = Schema.Struct({
  ...
  diffAckStatus: Schema.optional(ThreadHandoffDiffAckStatus),
  checkpointRef: Schema.optional(Schema.NullOr(CheckpointRef)),
  baseCheckpointRef: Schema.optional(Schema.NullOr(CheckpointRef)),
  baseHeadSha: Schema.optional(Schema.NullOr(TrimmedNonEmptyString)),
  checkpointStatus: Schema.optional(ThreadHandoffCheckpointStatus),
  createdAt: IsoDateTime,
});

const ThreadHandoffReturnCommand = Schema.Struct({
  type: Schema.Literal("thread.handoff.return"),
  commandId: CommandId,
  /** Original thread that receives the return payload. */
  sourceThreadId: ThreadId,
  /** Handoff target thread that is returning. */
  fromThreadId: ThreadId,
  summary: TrimmedNonEmptyString,
  repoSnapshot: Schema.optional(Schema.NullOr(ThreadHandoffRepoSnapshot)).pipe(
    Schema.withDecodingDefault(() => null),
...
const ThreadMetaUpdateCommand = Schema.Struct({
  ...
  handoffReturn: Schema.optional(Schema.NullOr(ThreadHandoffReturnPayload)),
...
export const ThreadTurnStartCommand = Schema.Struct({
  ...
  workspaceMode: Schema.optional(Schema.Literal("research")),
  sourceProposedPlan: Schema.optional(SourceProposedPlanReference),
  createdAt: IsoDateTime,
});
...
export type OrchestrationCaptureHandoffCheckpointInput =
  typeof OrchestrationCaptureHandoffCheckpointInput.Type;

export const OrchestrationCaptureHandoffCheckpointResult = Schema.Struct({
  ...
  /** True when an existing seam checkpoint already matched the working tree. */
  unchanged: Schema.optional(Schema.Boolean).pipe(Schema.withDecodingDefault(() => false)),
});
...
export type OrchestrationGetHandoffCheckpointDiffInput =
  typeof OrchestrationGetHandoffCheckpointDiffInput.Type;

export const OrchestrationGetHandoffCheckpointDiffResult = Schema.Struct({
  threadId: ThreadId,
  diff: Schema.String,
  checkpointRef: Schema.NullOr(CheckpointRef),
  baseCheckpointRef: Schema.NullOr(CheckpointRef),
...
export type OrchestrationGetHandoffCheckpointDiffResult =
  typeof OrchestrationGetHandoffCheckpointDiffResult.Type;

export const OrchestrationRestoreHandoffCheckpointInput = Schema.Struct({
  threadId: ThreadId,
  cwd: TrimmedNonEmptyString,
});
export type OrchestrationRestoreHandoffCheckpointInput =
  typeof OrchestrationRestoreHandoffCheckpointInput.Type;

export const OrchestrationRestoreHandoffCheckpointResult = Schema.Struct({
  restored: Schema.Boolean,
  checkpointRef: Schema.NullOr(CheckpointRef),
});
export type OrchestrationRestoreHandoffCheckpointResult =
  typeof OrchestrationRestoreHandoffCheckpointResult.Type;
...
export const OrchestrationRpcSchemas = {
  ...
  captureHandoffCheckpoint: {
    ...
    output: OrchestrationCaptureHandoffCheckpointResult,
  },
  getHandoffCheckpointDiff: {
    input: OrchestrationGetHandoffCheckpointDiffInput,
    output: OrchestrationGetHandoffCheckpointDiffResult,
  },
  restoreHandoffCheckpoint: {
    input: OrchestrationRestoreHandoffCheckpointInput,
    output: OrchestrationRestoreHandoffCheckpointResult,
  },
  replayEvents: {
