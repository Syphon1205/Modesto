...
export const SourceControlListedRepository = Schema.Struct({
  provider: SourceControlProviderKind,
  nameWithOwner: TrimmedNonEmptyString,
  url: TrimmedNonEmptyString,
  sshUrl: TrimmedNonEmptyString,
...
export type SourceControlListedRepository = typeof SourceControlListedRepository.Type;
...
export const SourceControlListRepositoriesResult = Schema.Struct({
  repositories: Schema.Array(SourceControlListedRepository),
});
