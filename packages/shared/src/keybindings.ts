...
export const DEFAULT_KEYBINDINGS: ReadonlyArray<KeybindingRule> = [
  ...
  // Tab strip, matching OpenCode's own `tab.new` / `tab.close` commands and
  // the browser/editor convention everyone already has in their fingers.
  { key: "mod+t", command: "tab.new", when: "!terminalFocus" },
