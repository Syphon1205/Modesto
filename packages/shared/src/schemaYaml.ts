 ...
 *
 * ```ts
 * import { parseYaml } from "@modesto/shared/schemaYaml"
 *
 ...
 *
 * ```ts
 * import { stringifyYaml } from "@modesto/shared/schemaYaml"
 *
 ...
 * ```ts
 * import * as Schema from "effect/Schema"
 * import { fromYamlString } from "@modesto/shared/schemaYaml"
 *
