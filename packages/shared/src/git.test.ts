import type { VcsStatusRemoteResult, VcsStatusResult } from "@modesto/contracts";
...
describe("normalizeGitRemoteUrl", () => {
  it("canonicalizes equivalent GitHub remotes across protocol variants", () => {
    expect(normalizeGitRemoteUrl("git@github.com:octocat/example-repo.git")).toBe(
      "github.com/octocat/example-repo",
    );
    expect(normalizeGitRemoteUrl("https://github.com/octocat/example-repo.git")).toBe(
      "github.com/octocat/example-repo",
    );
    expect(normalizeGitRemoteUrl("ssh://git@github.com/octocat/example-repo")).toBe(
      "github.com/octocat/example-repo",
    );
  });

  it("preserves nested group paths for providers like GitLab", () => {
    expect(normalizeGitRemoteUrl("git@gitlab.com:octocat/platform/example-repo.git")).toBe(
      "gitlab.com/octocat/platform/example-repo",
    );
    expect(normalizeGitRemoteUrl("https://gitlab.com/octocat/platform/example-repo.git")).toBe(
      "gitlab.com/octocat/platform/example-repo",
    );
  });
...
describe("parseGitHubRepositoryNameWithOwnerFromRemoteUrl", () => {
  it("extracts the owner and repository from common GitHub remote shapes", () => {
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("git@github.com:octocat/example-repo.git"),
    ).toBe("octocat/example-repo");
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl(
