// This tree's OrchestrationThreadShell has no explicit envMode field (worktree
// intent is carried purely by worktreePath), unlike the original Modesto
// schema this module was ported from - defined locally instead of imported.
