 ...
 *
 * This lives in `@modesto/shared` because two independent callers derive the
...
/** `~/Library/Caches/modesto/device-helper` — callers pass their own home dir. */
...
export const DEVICE_HELPER_BINARY_NAME = "modesto-device-helper";

/** Physical helper source directory passed from packaged desktop to its backend child. */
export const DEVICE_HELPER_SOURCE_DIR_ENV = "MODESTO_DEVICE_HELPER_SOURCE_DIR";
