export const BUILT_IN_THEME_IDS = ["modesto", "grove", "ocean", "ember", "iris"] as const;

/** The palette the mobile app opens with; the product default everywhere. */
export const MOBILE_DEFAULT_THEME_ID = "modesto";
 ...
 */
export const MOBILE_THEME_IDS = BUILT_IN_THEME_IDS;
 ...
 *
 * Quiet field, one signal: paper/ink grounds from the Astro brand system,
 * lime as the only accent fill, and green/amber reserved for status.
 */
export const MODESTO_THEME: ThemeDefinition = {
  id: "modesto",
  label: "Signal",
  // Light is the *base* appearance, which is a resolution detail rather than a
  // preference: the boot script reads every built-in from a light base, and a
  // dark-first built-in would resolve the wrong half before React mounts. Both
  // halves are fully specified, so what a user sees still follows their own
  // appearance setting.
  appearance: "light",
  colors: {
    canvas: "oklch(0.929689 0.024218 85.789)",
    chrome: "oklch(0.96751 0.013909 88.683)",
    toolbar: "oklch(0.96751 0.013909 88.683)",
    toolbarForeground: "oklch(0.190153 0.012694 129.232)",
    toolbarBorder: "oklch(0.895795 0.030995 88.381)",
    toolbarControl: "oklch(0.940441 0.022194 89.795)",
    toolbarControlForeground: "oklch(0.190153 0.012694 129.232)",
    toolbarControlHover: "oklch(0.895795 0.030995 88.381)",
    surface: "oklch(0.940441 0.022194 89.795)",
    surfaceRaised: "oklch(0.96751 0.013909 88.683)",
    surfaceOverlay: "oklch(0.96751 0.013909 88.683)",
    text: "oklch(0.190153 0.012694 129.232)",
    textMuted: "oklch(0.493212 0.031456 128.19)",
    border: "oklch(0.895795 0.030995 88.381)",
    input: "oklch(0.86 0.032 88)",
    focus: "oklch(0.477467 0.111256 130.966)",
    accent: "oklch(0.934173 0.131826 125.034)",
    accentForeground: "oklch(0.201512 0.018331 127.442)",
    secondary: "oklch(0.902147 0.029707 87.55)",
    secondaryForeground: "oklch(0.190153 0.012694 129.232)",
    muted: "oklch(0.940441 0.022194 89.795)",
    mutedForeground: "oklch(0.493212 0.031456 128.19)",
    placeholder: "oklch(0.493212 0.031456 128.19)",
    secondaryLabel: "oklch(0.493212 0.031456 128.19)",
    iconMuted: "oklch(0.493212 0.031456 128.19)",
    error: "oklch(0.64 0.21 25)",
    errorForeground: "oklch(0.52 0.2 25)",
    errorSurface: "oklch(0.95 0.03 25)",
    warning: "oklch(0.76 0.15 75)",
    warningForeground: "oklch(0.48 0.12 75)",
    warningSurface: "oklch(0.96 0.04 75)",
    update: "oklch(0.72 0.16 150)",
    updateForeground: "oklch(0.46 0.13 150)",
    updateSurface: "oklch(0.95 0.04 150)",
    accentSurface: "oklch(0.934972 0.046359 121.885)",
    accentSurfaceForeground: "oklch(0.190153 0.012694 129.232)",
    messageSurface: "oklch(0.940441 0.022194 89.795)",
    messageForeground: "oklch(0.190153 0.012694 129.232)",
    messageAction: "oklch(0.934173 0.131826 125.034)",
    messageActionForeground: "oklch(0.201512 0.018331 127.442)",
    messageActionHover: "oklch(0.882211 0.137916 124.681)",
    codeBackground: "oklch(0.902147 0.029707 87.55)",
    codeForeground: "oklch(0.190153 0.012694 129.232)",
    sidebar: "oklch(0.96751 0.013909 88.683)",
    sidebarForeground: "oklch(0.190153 0.012694 129.232)",
    sidebarMutedForeground: "oklch(0.493212 0.031456 128.19)",
    sidebarControlSurface: "oklch(0.929689 0.024218 85.789)",
    sidebarRowHover: "oklch(0.190153 0.012694 129.232 / 0.04)",
    sidebarRowActive: "oklch(0.190153 0.012694 129.232 / 0.06)",
    sidebarRowSelected: "oklch(0.190153 0.012694 129.232 / 0.08)",
    sidebarBorder: "oklch(0.895795 0.030995 88.381)",
    terminalBackground: "oklch(0.929689 0.024218 85.789)",
    terminalForeground: "oklch(0.190153 0.012694 129.232)",
    terminalCursor: "oklch(0.477467 0.111256 130.966)",
    terminalSelection: "oklch(0.477467 0.111256 130.966 / 0.18)",
    terminalScrollbar: "oklch(0.190153 0.012694 129.232 / 0.12)",
    terminalScrollbarHover: "oklch(0.190153 0.012694 129.232 / 0.2)",
  },
  // Matches the other reviewed built-ins: the sidebar may carry product
  // artwork over this palette.
  sidebarArtwork: true,
  variants: {
    dark: {
      canvas: "oklch(0.178727 0.006829 135.02)",
      chrome: "oklch(0.212309 0.012373 129.129)",
      toolbar: "oklch(0.212309 0.012373 129.129)",
      toolbarForeground: "oklch(0.945376 0.010829 118.028)",
      toolbarBorder: "oklch(0.232555 0.01441 131.819)",
      toolbarControl: "oklch(0.232555 0.01441 131.819)",
      toolbarControlForeground: "oklch(0.945376 0.010829 118.028)",
      toolbarControlHover: "oklch(0.249913 0.02513 128.233)",
      surface: "oklch(0.232555 0.01441 131.819)",
      surfaceRaised: "oklch(0.249913 0.02513 128.233)",
      surfaceOverlay: "oklch(0.249913 0.02513 128.233)",
      text: "oklch(0.945376 0.010829 118.028)",
      textMuted: "oklch(0.65815 0.032919 129.938)",
      border: "oklch(0.232555 0.01441 131.819)",
      input: "oklch(0.249913 0.02513 128.233)",
      focus: "oklch(0.934173 0.131826 125.034)",
      accent: "oklch(0.934173 0.131826 125.034)",
      accentForeground: "oklch(0.201512 0.018331 127.442)",
      secondary: "oklch(0.232555 0.01441 131.819)",
      secondaryForeground: "oklch(0.945376 0.010829 118.028)",
      muted: "oklch(0.212309 0.012373 129.129)",
      mutedForeground: "oklch(0.65815 0.032919 129.938)",
      placeholder: "oklch(0.65815 0.032919 129.938)",
      secondaryLabel: "oklch(0.65815 0.032919 129.938)",
      iconMuted: "oklch(0.65815 0.032919 129.938)",
      error: "oklch(0.64 0.21 25)",
      errorForeground: "oklch(0.75 0.17 25)",
      errorSurface: "oklch(0.3 0.07 25)",
      warning: "oklch(0.76 0.15 75)",
      warningForeground: "oklch(0.85 0.14 75)",
      warningSurface: "oklch(0.32 0.06 75)",
      update: "oklch(0.72 0.16 150)",
      updateForeground: "oklch(0.82 0.14 150)",
      updateSurface: "oklch(0.31 0.06 150)",
      accentSurface: "oklch(0.249913 0.02513 128.233)",
      accentSurfaceForeground: "oklch(0.945376 0.010829 118.028)",
      messageSurface: "oklch(0.232555 0.01441 131.819)",
      messageForeground: "oklch(0.945376 0.010829 118.028)",
      messageAction: "oklch(0.934173 0.131826 125.034)",
      messageActionForeground: "oklch(0.201512 0.018331 127.442)",
      messageActionHover: "oklch(0.882211 0.137916 124.681)",
      codeBackground: "oklch(0.160204 0.007013 135.049)",
      codeForeground: "oklch(0.945376 0.010829 118.028)",
      sidebar: "oklch(0.212309 0.012373 129.129)",
      sidebarForeground: "oklch(0.945376 0.010829 118.028)",
      sidebarMutedForeground: "oklch(0.65815 0.032919 129.938)",
      sidebarControlSurface: "oklch(0.249913 0.02513 128.233)",
      sidebarRowHover: "oklch(0.945376 0.010829 118.028 / 0.04)",
      sidebarRowActive: "oklch(0.945376 0.010829 118.028 / 0.07)",
      sidebarRowSelected: "oklch(0.945376 0.010829 118.028 / 0.09)",
      sidebarBorder: "oklch(0.232555 0.01441 131.819)",
      terminalBackground: "oklch(0.178727 0.006829 135.02)",
      terminalForeground: "oklch(0.945376 0.010829 118.028)",
      terminalCursor: "oklch(0.934173 0.131826 125.034)",
      terminalSelection: "oklch(0.934173 0.131826 125.034 / 0.18)",
      terminalScrollbar: "oklch(0.945376 0.010829 118.028 / 0.12)",
      terminalScrollbarHover: "oklch(0.945376 0.010829 118.028 / 0.2)",
    },
  },
};
