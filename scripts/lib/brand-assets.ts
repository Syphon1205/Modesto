export const BRAND_ASSET_PATHS = {
  ...
  productionWindowsIconIco: "assets/prod/modesto-black-windows.ico",
  productionWebFaviconIco: "assets/prod/modesto-black-web-favicon.ico",
  productionWebFavicon16Png: "assets/prod/modesto-black-web-favicon-16x16.png",
  productionWebFavicon32Png: "assets/prod/modesto-black-web-favicon-32x32.png",
  productionWebAppleTouchIconPng: "assets/prod/modesto-black-web-apple-touch-180.png",
...
// Modesto ships two icon tiers today (development/production) - no "nightly"
// asset set exists yet, unlike T3's three-tier scheme this file's function
// API was ported from. Add a "nightly" arm here (and matching
// BRAND_ASSET_PATHS.nightly* entries + assets) if/when Modesto grows a
// nightly release channel with its own icon set.
...
export function resolveWebAssetBrandForPackageVersion(version: string): WebAssetBrand {
  return version.includes("-dev.") || version.includes("-nightly.") ? "development" : "production";
}
...
export const DEVELOPMENT_ICON_OVERRIDES: ReadonlyArray<IconOverride> = resolveWebIconOverrides(
  "development",
  "dist/client",
);

export const PUBLISH_ICON_OVERRIDES: ReadonlyArray<IconOverride> = resolveWebIconOverrides(
  "production",
  "dist/client",
);
