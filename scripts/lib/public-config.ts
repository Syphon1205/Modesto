...
export interface ModestoPublicConfig {
...
export function loadRepoEnv({
  ...
  return {
    ...
    ...(config.clerkPublishableKey
      ? {
          MODESTO_CLERK_PUBLISHABLE_KEY: config.clerkPublishableKey,
    ...
    ...(config.clerkJwtTemplate
      ? {
          MODESTO_CLERK_JWT_TEMPLATE: config.clerkJwtTemplate,
...
export function resolvePublicConfig(...sources: readonly Environment[]): ModestoPublicConfig {
  return {
