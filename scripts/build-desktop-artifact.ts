...
import { MODESTO_PRODUCTION_BUNDLE_ID } from "@modesto/shared/desktopIdentity";
...
const buildDesktopArtifact = Effect.fn("buildDesktopArtifact")(function* (
  ...
  const resolvedServerDependencies = Object.fromEntries(
    Object.entries(resolvedServerDependenciesWithProviderClis).filter(
