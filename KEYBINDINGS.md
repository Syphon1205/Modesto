...
Modesto reads keybindings from:

- `~/.modesto/userdata/keybindings.json`

On first launch, Modesto copies an existing `~/.modesto` profile when no Modesto profile exists. The legacy directory is retained for rollback.
